...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gaussian_filter_accel_fifo_w64_d4_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {dout_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gaussian_filter_accel_fifo_w19_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {p_channel_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gaussian_filter_accel_fifo_w19_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {axibound_V_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gaussian_filter_accel_fifo_w256_d2_S_x BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {ldata_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_mat_data2_dout { I 8 vector } out_mat_data2_empty_n { I 1 bit } out_mat_data2_read { O 1 bit } } \
} "
}
