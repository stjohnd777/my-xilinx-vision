set moduleName xfMat2Array_256_0_1080_1920_1_1_1_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {xfMat2Array<256, 0, 1080, 1920, 1, 1, 1>}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_read int 32 regular  }
	{ p_read1 int 32 regular  }
	{ out_mat_data2 int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_mat_data2", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_mat_data2_dout sc_in sc_lv 8 signal 2 } 
	...
	{ m_axi_gmem2_WDATA sc_out sc_lv 256 signal 3 } 
	{ m_axi_gmem2_WSTRB sc_out sc_lv 32 signal 3 } 
	...
	{ m_axi_gmem2_RDATA sc_in sc_lv 256 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_mat_data2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "out_mat_data2", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "out_mat_data2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_62", "Port" : "out_mat_data2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_62", "Port" : "gmem2", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.entry_proc4_U0", "Parent" : "1",
		"CDFG" : "entry_proc4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.addrbound_U0", "Parent" : "1", "Child" : ["4"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.addrbound_U0.mul_mul_16ns_16ns_32_3_1_U79", "Parent" : "3"},
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0", "Parent" : "1", "Child" : ["7", "8", "9", "13", "14", "15"],
		...
		"OutputProcess" : [
			{"ID" : "9", "Name" : "MatStream2AxiStream_1_U0"}],
		"Port" : [
			{"Name" : "out_mat_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_1_U0", "Port" : "out_mat_data2"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["16"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_1_U0", "Port" : "ldata1"}]},
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_1_U0", "Parent" : "6", "Child" : ["10", "12"],
		...
		"Port" : [
			{"Name" : "out_mat_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "out_mat_data2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["16"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ldata1_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "ldata1", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "10", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_1_U0.grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Parent" : "9", "Child" : ["11"],
	...
	{"ID" : "11", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_1_U0.grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.flow_control_loop_pipe_sequential_init_U", "Parent" : "10"},
	{"ID" : "12", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_1_U0.mul_mul_16ns_16ns_32_4_1_U98", "Parent" : "9"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "81", "Max" : "2073611"}
	, {"Name" : "Interval", "Min" : "81", "Max" : "2073611"}
]}
...
set Spec2ImplPortList { 
	...
	out_mat_data2 { ap_fifo {  { out_mat_data2_dout fifo_port_we 0 8 }  { out_mat_data2_num_data_valid fifo_status_num_data_valid 0 2 }  { out_mat_data2_fifo_cap fifo_update 0 2 }  { out_mat_data2_empty_n fifo_status 0 1 }  { out_mat_data2_read fifo_data 1 1 } } }
