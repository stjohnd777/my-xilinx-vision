...
entity threshold_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of threshold_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 is 
...
attribute shreg_extract : string;
    ...
    signal i_V_fu_56 : STD_LOGIC_VECTOR (16 downto 0);
    signal add_ln840_fu_104_p2 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
    ...
    add_ln840_fu_104_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_3) + unsigned(ap_const_lv17_1));
    ...
    ap_sig_allocacmp_i_V_3_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_V_fu_56, ap_loop_init)
    begin
    ...
    icmp_ln1027_fu_98_p2 <= "1" when (ap_sig_allocacmp_i_V_3 = p_read) else "0";
