...
set portList { 
	...
	{ p_dstgx_data2_dout sc_in sc_lv 8 signal 0 } 
	{ p_dstgx_data2_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ p_dstgx_data2_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ p_dstgx_data2_empty_n sc_in sc_logic 1 signal 0 } 
	{ p_dstgx_data2_read sc_out sc_logic 1 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "p_dstgx_data2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_16ns_16ns_32_4_1_U141", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "8294408"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "8294408"}
]}
