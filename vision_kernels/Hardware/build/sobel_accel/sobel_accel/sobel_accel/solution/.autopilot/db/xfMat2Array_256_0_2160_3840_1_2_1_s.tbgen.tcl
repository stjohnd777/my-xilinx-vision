set moduleName xfMat2Array_256_0_2160_3840_1_2_1_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {xfMat2Array<256, 0, 2160, 3840, 1, 2, 1>}
...
set portList { 
	...
	{ p_dstgx_data2_dout sc_in sc_lv 8 signal 2 } 
	{ p_dstgx_data2_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ p_dstgx_data2_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ p_dstgx_data2_empty_n sc_in sc_logic 1 signal 2 } 
	{ p_dstgx_data2_read sc_out sc_logic 1 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "p_dstgx_data2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
