...
set portNum 62
set portList { 
	{ p_dstgy_data3_dout sc_in sc_lv 8 signal 0 } 
	{ p_dstgy_data3_empty_n sc_in sc_logic 1 signal 0 } 
	{ p_dstgy_data3_read sc_out sc_logic 1 signal 0 } 
	...
	{ m_axi_gmem3_WDATA sc_out sc_lv 256 signal 1 } 
	{ m_axi_gmem3_WSTRB sc_out sc_lv 32 signal 1 } 
	...
	{ m_axi_gmem3_RDATA sc_in sc_lv 256 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "5", "15", "18", "19", "20", "21"],
		...
		"Port" : [
			{"Name" : "p_dstgy_data3", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "Mat2AxiStream_U0", "Port" : "p_dstgx_data2"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc10_U0", "Parent" : "0",
		"CDFG" : "entry_proc10",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.addrbound_U0", "Parent" : "0", "Child" : ["3"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.addrbound_U0.mul_mul_16ns_16ns_32_3_1_U122", "Parent" : "2"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0", "Parent" : "0", "Child" : ["6", "7", "8", "12", "13", "14"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "p_dstgx_data2"}]},
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_2_U0", "Parent" : "5", "Child" : ["9", "11"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "p_dstgx_data2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["15"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.mul_mul_16ns_16ns_32_4_1_U141", "Parent" : "8"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "79", "Max" : "8294409"}
	, {"Name" : "Interval", "Min" : "76", "Max" : "8294409"}
]}
...
set Spec2ImplPortList { 
	p_dstgy_data3 { ap_fifo {  { p_dstgy_data3_dout fifo_port_we 0 8 }  { p_dstgy_data3_empty_n fifo_status 0 1 }  { p_dstgy_data3_read fifo_data 1 1 } } }
