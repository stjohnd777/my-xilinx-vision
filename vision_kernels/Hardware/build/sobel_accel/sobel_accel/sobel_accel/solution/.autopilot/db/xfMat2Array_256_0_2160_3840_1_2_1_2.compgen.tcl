...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dstgy_data3_dout { I 8 vector } p_dstgy_data3_num_data_valid { I 2 vector } p_dstgy_data3_fifo_cap { I 2 vector } p_dstgy_data3_empty_n { I 1 bit } p_dstgy_data3_read { O 1 bit } } \
} "
}
