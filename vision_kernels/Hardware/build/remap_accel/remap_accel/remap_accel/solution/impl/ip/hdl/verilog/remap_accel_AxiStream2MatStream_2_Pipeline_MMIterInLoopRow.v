...
module remap_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [7:0] p_Result_7_fu_506_p2;
wire   [7:0] p_Result_6_fu_645_p2;
...
always @ (*) begin
    ap_condition_584 = ((icmp_ln1066_reg_762 == 1'd1) & (icmp_ln1055_reg_753 == 1'd1) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_condition_587 = ((icmp_ln1055_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1066_fu_235_p2 == 1'd0));
end

always @ (*) begin
    ap_condition_590 = ((icmp_ln1055_fu_193_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1066_fu_235_p2 == 1'd1));
end
...
assign j_4_fu_447_p3 = ((bLast_width_fu_204_p2[0:0] == 1'b1) ? 32'd0 : add_ln1087_fu_441_p2);

assign localbuffer_V_7_fu_563_p3 = ((icmp_ln1067_reg_783[0:0] == 1'b1) ? 8'd0 : p_Result_4_fu_557_p2);
...
assign p_Result_4_fu_557_p2 = (p_Result_s_fu_536_p2 & lshr_ln368_fu_551_p2);

assign p_Result_5_fu_585_p2 = (lshr_ln628_2_fu_579_p2 & ldata1_dout);

assign p_Result_6_fu_645_p2 = (and_ln368_2_fu_640_p2 | and_ln368_1_fu_634_p2);

assign p_Result_7_fu_506_p2 = (lshr_ln628_4_reg_778 & lshr_ln628_3_fu_500_p2);
...
assign select_ln628_1_fu_483_p3 = ((icmp_ln628_reg_766[0:0] == 1'b1) ? tmp_25_fu_468_p4 : p_Val2_s_fu_92);
...
assign shl_ln368_fu_606_p2 = p_Result_5_fu_585_p2 << zext_ln368_1_fu_602_p1;
...
always @ (p_Val2_s_fu_92) begin
    for (ap_tvar_int_0 = 8 - 1; ap_tvar_int_0 >= 0; ap_tvar_int_0 = ap_tvar_int_0 - 1) begin
        if (ap_tvar_int_0 > 7 - 0) begin
            tmp_25_fu_468_p4[ap_tvar_int_0] = 1'b0;
        end else begin
            tmp_25_fu_468_p4[ap_tvar_int_0] = p_Val2_s_fu_92[7 - ap_tvar_int_0];
        end
    end
end
...
endmodule //remap_accel_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow
