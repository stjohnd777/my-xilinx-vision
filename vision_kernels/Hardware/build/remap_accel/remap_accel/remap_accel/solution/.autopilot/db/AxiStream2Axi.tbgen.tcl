...
set portList { 
	...
	{ p_read sc_in sc_lv 22 signal 3 } 
}
set NewPortList {[ 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "gmem3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "75", "Max" : "2073674"}
	, {"Name" : "Interval", "Min" : "75", "Max" : "2073674"}
]}
