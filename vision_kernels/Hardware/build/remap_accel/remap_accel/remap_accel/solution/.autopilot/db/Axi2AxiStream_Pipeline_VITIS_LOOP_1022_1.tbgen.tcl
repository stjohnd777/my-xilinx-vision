...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_in","offset": { "type": "dynamic","port_name": "img_in","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "mul_ln1022", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln1022 sc_in sc_lv 22 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln1022", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "mul_ln1022", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	mul_ln1022 { ap_none {  { mul_ln1022 in_data 0 22 } } }
