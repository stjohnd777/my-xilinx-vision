...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgOutput_data4_dout { I 8 vector } imgOutput_data4_num_data_valid { I 2 vector } imgOutput_data4_fifo_cap { I 2 vector } imgOutput_data4_empty_n { I 1 bit } imgOutput_data4_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata1 \
    op interface \
    ports { ldata1_din { O 8 vector } ldata1_num_data_valid { I 2 vector } ldata1_fifo_cap { I 2 vector } ldata1_full_n { I 1 bit } ldata1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { localbuffer_V_3_out { O 8 vector } localbuffer_V_3_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { filled_V_1_out { O 4 vector } filled_V_1_out_ap_vld { O 1 bit } } \
} "
}
