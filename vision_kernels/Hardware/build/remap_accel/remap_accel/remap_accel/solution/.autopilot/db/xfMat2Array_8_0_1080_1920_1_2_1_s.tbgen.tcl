set moduleName xfMat2Array_8_0_1080_1920_1_2_1_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {xfMat2Array<8, 0, 1080, 1920, 1, 2, 1>}
set C_modelType { void 0 }
set C_modelArgList {
	{ p_read int 32 regular  }
	{ p_read1 int 32 regular  }
	{ imgOutput_data4 int 8 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "imgOutput_data4", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ imgOutput_data4_dout sc_in sc_lv 8 signal 2 } 
	{ imgOutput_data4_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ imgOutput_data4_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ imgOutput_data4_empty_n sc_in sc_logic 1 signal 2 } 
	{ imgOutput_data4_read sc_out sc_logic 1 signal 2 } 
	...
	{ m_axi_gmem3_WDATA sc_out sc_lv 8 signal 3 } 
	{ m_axi_gmem3_WSTRB sc_out sc_lv 1 signal 3 } 
	...
	{ m_axi_gmem3_RDATA sc_in sc_lv 8 signal 3 } 
	{ m_axi_gmem3_RLAST sc_in sc_logic 1 signal 3 } 
	{ m_axi_gmem3_RID sc_in sc_lv 1 signal 3 } 
	{ m_axi_gmem3_RFIFONUM sc_in sc_lv 11 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "imgOutput_data4_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "imgOutput_data4", "role": "dout" }} , 
 	...
 	{ "name": "imgOutput_data4_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgOutput_data4", "role": "empty_n" }} , 
 	{ "name": "imgOutput_data4_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "imgOutput_data4", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0","-1"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Mat2Axi_fu_62", "Port" : "imgOutput_data4", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62", "Parent" : "0", "Child" : ["2", "3", "5", "6", "16", "19", "20", "21", "22"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Mat2AxiStream_U0", "Port" : "imgOutput_data4"}]},
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "16", "SubInstance" : "AxiStream2Axi_U0", "Port" : "gmem3"}]},
			{"Name" : "dout", "Type" : "None", "Direction" : "I"},
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.entry_proc6_U0", "Parent" : "1",
		"CDFG" : "entry_proc6",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.addrbound_U0", "Parent" : "1", "Child" : ["4"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.addrbound_U0.mul_mul_16ns_16ns_32_3_1_U149", "Parent" : "3"},
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0", "Parent" : "1", "Child" : ["7", "8", "9", "13", "14", "15"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "imgOutput_data4"}]},
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_2_U0", "Parent" : "6", "Child" : ["10", "12"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput_data4", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["16"], "DependentChan" : "22", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "12", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.mul_mul_16ns_16ns_32_4_1_U168", "Parent" : "9"},
	...
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Mat2Axi_fu_62.AxiStream2Axi_U0", "Parent" : "1", "Child" : ["17"],
		...
		"Port" : [
			...
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "17", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "gmem3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
...
set Spec2ImplPortList { 
	...
	imgOutput_data4 { ap_fifo {  { imgOutput_data4_dout fifo_port_we 0 8 }  { imgOutput_data4_num_data_valid fifo_status_num_data_valid 0 2 }  { imgOutput_data4_fifo_cap fifo_update 0 2 }  { imgOutput_data4_empty_n fifo_status 0 1 }  { imgOutput_data4_read fifo_data 1 1 } } }
