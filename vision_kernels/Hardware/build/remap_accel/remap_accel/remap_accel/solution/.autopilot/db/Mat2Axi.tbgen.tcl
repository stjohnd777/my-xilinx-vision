...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "5", "15", "18", "19", "20", "21"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "Mat2AxiStream_U0", "Port" : "imgOutput_data4"}]},
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "15", "SubInstance" : "AxiStream2Axi_U0", "Port" : "gmem3"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.addrbound_U0", "Parent" : "0", "Child" : ["3"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.addrbound_U0.mul_mul_16ns_16ns_32_3_1_U149", "Parent" : "2"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0", "Parent" : "0", "Child" : ["6", "7", "8", "12", "13", "14"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "imgOutput_data4"}]},
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_2_U0", "Parent" : "5", "Child" : ["9", "11"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput_data4", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["15"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_2_U0.mul_mul_16ns_16ns_32_4_1_U168", "Parent" : "8"},
	...
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AxiStream2Axi_U0", "Parent" : "0", "Child" : ["16"],
		...
		"Port" : [
			...
			{"Name" : "gmem3", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "16", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_67", "Port" : "gmem3", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "76", "Max" : "2073675"}
]}
...
set Spec2ImplPortList { 
	imgOutput_data4 { ap_fifo {  { imgOutput_data4_dout fifo_port_we 0 8 }  { imgOutput_data4_empty_n fifo_status 0 1 }  { imgOutput_data4_read fifo_data 1 1 } } }
