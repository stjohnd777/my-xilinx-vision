...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata1 \
    op interface \
    ports { ldata1_dout { I 64 vector } ldata1_num_data_valid { I 2 vector } ldata1_fifo_cap { I 2 vector } ldata1_empty_n { I 1 bit } ldata1_read { O 1 bit } } \
} "
}
