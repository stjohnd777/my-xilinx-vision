...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata \
    op interface \
    ports { ldata_din { O 64 vector } ldata_num_data_valid { I 2 vector } ldata_fifo_cap { I 2 vector } ldata_full_n { I 1 bit } ldata_write { O 1 bit } } \
} "
}
