set moduleName xFAverageGaussianMask3x3_Pipeline_Clear_Row_Loop
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {xFAverageGaussianMask3x3_Pipeline_Clear_Row_Loop}
set C_modelType { void 0 }
set C_modelArgList {
	{ img_width int 16 regular  }
	{ buf_V_5 int 8 regular {array 1920 { 3 0 } 0 1 }  }
...
set portList { 
	...
	{ in_mat_data1_dout sc_in sc_lv 8 signal 3 } 
	{ in_mat_data1_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ in_mat_data1_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ in_mat_data1_empty_n sc_in sc_logic 1 signal 3 } 
	{ in_mat_data1_read sc_out sc_logic 1 signal 3 } 
	{ img_width sc_in sc_lv 16 signal 0 } 
	{ buf_V_5_address1 sc_out sc_lv 11 signal 1 } 
	{ buf_V_5_ce1 sc_out sc_logic 1 signal 1 } 
	{ buf_V_5_we1 sc_out sc_logic 1 signal 1 } 
	{ buf_V_5_d1 sc_out sc_lv 8 signal 1 } 
...
set Spec2ImplPortList { 
	...
	buf_V_5 { ap_memory {  { buf_V_5_address1 MemPortADDR2 1 11 }  { buf_V_5_ce1 MemPortCE2 1 1 }  { buf_V_5_we1 MemPortWE2 1 1 }  { buf_V_5_d1 MemPortDIN2 1 8 } } }
