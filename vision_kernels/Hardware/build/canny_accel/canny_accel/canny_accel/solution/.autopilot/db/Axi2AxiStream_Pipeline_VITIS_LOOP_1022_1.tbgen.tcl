...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_inp","offset": { "type": "dynamic","port_name": "img_inp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln1022", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ldata_din sc_out sc_lv 64 signal 3 } 
	...
	{ sext_ln1022 sc_in sc_lv 61 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1022", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln1022", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "243"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "243"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln1022 { ap_none {  { sext_ln1022 in_data 0 61 } } }
