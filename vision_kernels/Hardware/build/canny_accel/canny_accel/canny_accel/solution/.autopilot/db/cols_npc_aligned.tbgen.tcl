set moduleName cols_npc_aligned
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {cols_npc_aligned}
set C_modelType { int 14 }
set C_modelArgList {
	{ cols int 11 regular  }
	{ cols_c int 11 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "cols", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "cols_c", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ cols sc_in sc_lv 11 signal 0 } 
	{ cols_c_din sc_out sc_lv 11 signal 1 } 
	{ cols_c_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ cols_c_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ cols_c_full_n sc_in sc_logic 1 signal 1 } 
	{ cols_c_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cols_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "cols_c", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	cols_c { ap_fifo {  { cols_c_din fifo_port_we 1 11 }  { cols_c_num_data_valid fifo_status_num_data_valid 0 2 }  { cols_c_fifo_cap fifo_update 0 2 }  { cols_c_full_n fifo_status 0 1 }  { cols_c_write fifo_data 1 1 } } }
}
