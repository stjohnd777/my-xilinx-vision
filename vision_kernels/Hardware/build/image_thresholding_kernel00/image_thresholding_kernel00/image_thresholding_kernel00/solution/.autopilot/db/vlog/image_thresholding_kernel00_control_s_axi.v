...
// ==============================================================
`timescale 1ns/1ps
module image_thresholding_kernel00_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                 = 7'h08,
    ADDR_ISR                 = 7'h0c,
    ADDR_INPUT_IMAGE_DATA_0  = 7'h10,
    ADDR_INPUT_IMAGE_DATA_1  = 7'h14,
    ADDR_INPUT_IMAGE_CTRL    = 7'h18,
    ADDR_OUTPUT_IMAGE_DATA_0 = 7'h1c,
    ADDR_OUTPUT_IMAGE_DATA_1 = 7'h20,
    ADDR_OUTPUT_IMAGE_CTRL   = 7'h24,
    ADDR_N_DATA_0            = 7'h28,
    ADDR_N_CTRL              = 7'h2c,
    ADDR_M_DATA_0            = 7'h30,
    ADDR_M_CTRL              = 7'h34,
    ADDR_THRESHOLD_DATA_0    = 7'h38,
    ADDR_THRESHOLD_CTRL      = 7'h3c,
    ADDR_MAXVAL_DATA_0       = 7'h40,
    ADDR_MAXVAL_CTRL         = 7'h44,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    WRRESP                   = 2'd2,
    WRRESET                  = 2'd3,
