...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput_data1_din { O 8 vector } imgInput_data1_num_data_valid { I 2 vector } imgInput_data1_fifo_cap { I 2 vector } imgInput_data1_full_n { I 1 bit } imgInput_data1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput_rows_c_din { O 32 vector } imgInput_rows_c_num_data_valid { I 2 vector } imgInput_rows_c_fifo_cap { I 2 vector } imgInput_rows_c_full_n { I 1 bit } imgInput_rows_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput_cols_c_din { O 32 vector } imgInput_cols_c_num_data_valid { I 2 vector } imgInput_cols_c_fifo_cap { I 2 vector } imgInput_cols_c_full_n { I 1 bit } imgInput_cols_c_write { O 1 bit } } \
} "
}
