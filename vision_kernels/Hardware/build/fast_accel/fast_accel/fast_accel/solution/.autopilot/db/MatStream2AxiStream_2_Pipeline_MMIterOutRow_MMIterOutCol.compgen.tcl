...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgOutput_data2_dout { I 8 vector } imgOutput_data2_num_data_valid { I 2 vector } imgOutput_data2_fifo_cap { I 2 vector } imgOutput_data2_empty_n { I 1 bit } imgOutput_data2_read { O 1 bit } } \
} "
}
