...
set portNum 19
set portList { 
	{ ldata1_dout sc_in sc_lv 8 signal 0 } 
	{ ldata1_empty_n sc_in sc_logic 1 signal 0 } 
	{ ldata1_read sc_out sc_logic 1 signal 0 } 
	{ imgInput_data1_din sc_out sc_lv 8 signal 1 } 
	{ imgInput_data1_full_n sc_in sc_logic 1 signal 1 } 
	{ imgInput_data1_write sc_out sc_logic 1 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AxiStream2MatStream_2_U0", "Parent" : "0", "Child" : ["4", "6"],
		...
		"Port" : [
			...
			{"Name" : "imgInput_data1", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_AxiStream2MatStream_2_Pipeline_MMIterInLoopRow_fu_62", "Port" : "imgInput_data1", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7", "Max" : "8294406"}
	, {"Name" : "Interval", "Min" : "7", "Max" : "8294406"}
]}
...
set Spec2ImplPortList { 
	ldata1 { ap_fifo {  { ldata1_dout fifo_port_we 0 8 }  { ldata1_empty_n fifo_status 0 1 }  { ldata1_read fifo_data 1 1 } } }
