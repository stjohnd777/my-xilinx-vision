...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buf_V_3 \
    op interface \
    ports { buf_V_3_address1 { O 12 vector } buf_V_3_ce1 { O 1 bit } buf_V_3_we1 { O 1 bit } buf_V_3_d1 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buf_V_4 \
    op interface \
    ports { buf_V_4_address1 { O 12 vector } buf_V_4_ce1 { O 1 bit } buf_V_4_we1 { O 1 bit } buf_V_4_d1 { O 8 vector } } \
} "
} else {
