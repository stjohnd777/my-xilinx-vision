...
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln1075", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ imgInput_data1_din sc_out sc_lv 8 signal 8 } 
	{ imgInput_data1_num_data_valid sc_in sc_lv 2 signal 8 } 
	{ imgInput_data1_fifo_cap sc_in sc_lv 2 signal 8 } 
	{ imgInput_data1_full_n sc_in sc_logic 1 signal 8 } 
	{ imgInput_data1_write sc_out sc_logic 1 signal 8 } 
	...
	{ add_ln1075 sc_in sc_lv 5 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln1075", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "add_ln1075", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	add_ln1075 { ap_none {  { add_ln1075 in_data 0 5 } } }
