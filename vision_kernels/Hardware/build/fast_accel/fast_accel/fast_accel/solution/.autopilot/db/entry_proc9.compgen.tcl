...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_threshold_c \
    op interface \
    ports { threshold_c_din { O 8 vector } threshold_c_num_data_valid { I 3 vector } threshold_c_fifo_cap { I 3 vector } threshold_c_full_n { I 1 bit } threshold_c_write { O 1 bit } } \
} "
}
