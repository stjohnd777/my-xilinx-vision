...
module gaussian_filter_accel_Mat2AxiStream (
        out_mat_data2_dout,
...
wire    MatStream2AxiStream_2_U0_out_mat_data2_read;
...
gaussian_filter_accel_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
gaussian_filter_accel_MatStream2AxiStream_2_s MatStream2AxiStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
gaussian_filter_accel_fifo_w16_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
gaussian_filter_accel_fifo_w32_d3_S_x cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
gaussian_filter_accel_fifo_w4_d2_S_x last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign out_mat_data2_read = MatStream2AxiStream_2_U0_out_mat_data2_read;

endmodule //gaussian_filter_accel_Mat2AxiStream
