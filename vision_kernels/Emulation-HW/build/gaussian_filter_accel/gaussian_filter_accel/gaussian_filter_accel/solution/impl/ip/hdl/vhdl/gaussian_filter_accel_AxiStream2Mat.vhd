...
entity gaussian_filter_accel_AxiStream2Mat is
port (
...
architecture behav of gaussian_filter_accel_AxiStream2Mat is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc6_U0_rows_read : STD_LOGIC;
    signal entry_proc6_U0_rows_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc6_U0_rows_c_write : STD_LOGIC;
    signal entry_proc6_U0_cols_read : STD_LOGIC;
    signal entry_proc6_U0_cols_c_din : STD_LOGIC_VECTOR (31 downto 0);
    signal entry_proc6_U0_cols_c_write : STD_LOGIC;
    ...
    signal AxiStream2MatStream_2_U0_in_mat_data1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2MatStream_2_U0_in_mat_data1_write : STD_LOGIC;
    ...
    component gaussian_filter_accel_entry_proc6 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_last_blk_pxl_width IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_AxiStream2MatStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_fifo_w32_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_fifo_w4_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc6_U0 : component gaussian_filter_accel_entry_proc6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_U0 : component gaussian_filter_accel_last_blk_pxl_width
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2MatStream_2_U0 : component gaussian_filter_accel_AxiStream2MatStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    rows_c_U : component gaussian_filter_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc6_U0_rows_c_din,
        if_full_n => rows_c_full_n,
        if_write => entry_proc6_U0_rows_c_write,
        if_dout => rows_c_dout,
    ...
    cols_c_U : component gaussian_filter_accel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => entry_proc6_U0_cols_c_din,
        if_full_n => cols_c_full_n,
        if_write => entry_proc6_U0_cols_c_write,
        if_dout => cols_c_dout,
    ...
    last_blk_width_channel_U : component gaussian_filter_accel_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (last_blk_pxl_width_U0_ap_ext_blocking_n and entry_proc6_U0_ap_ext_blocking_n and AxiStream2MatStream_2_U0_ap_ext_blocking_n);
    ap_idle <= (last_blk_pxl_width_U0_ap_idle and (last_blk_width_channel_empty_n xor ap_const_logic_1) and entry_proc6_U0_ap_idle and AxiStream2MatStream_2_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (last_blk_pxl_width_U0_ap_int_blocking_n and entry_proc6_U0_ap_int_blocking_n and AxiStream2MatStream_2_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (last_blk_pxl_width_U0_ap_str_blocking_n and entry_proc6_U0_ap_str_blocking_n and AxiStream2MatStream_2_U0_ap_str_blocking_n);
    ...
    ap_sync_ready <= (ap_sync_last_blk_pxl_width_U0_ap_ready and ap_sync_entry_proc6_U0_ap_ready);
    cols_read <= entry_proc6_U0_cols_read;
