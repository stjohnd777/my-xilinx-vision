...
entity gaussian_filter_accel_Axi2Mat is
port (
...
architecture behav of gaussian_filter_accel_Axi2Mat is 
...
attribute shreg_extract : string;
    ...
    signal Axi2AxiStream_U0_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal Axi2AxiStream_U0_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal Axi2AxiStream_U0_ldata_din : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal AxiStream2Mat_U0_in_mat_data1_din : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2Mat_U0_in_mat_data1_write : STD_LOGIC;
    ...
    signal AxiStream2Mat_U0_ap_ext_blocking_n : STD_LOGIC;
    signal AxiStream2Mat_U0_ap_str_blocking_n : STD_LOGIC;
    signal AxiStream2Mat_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    component gaussian_filter_accel_Axi2AxiStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_AxiStream2Mat IS
    port (
    ...
    component gaussian_filter_accel_fifo_w256_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component gaussian_filter_accel_start_for_AxiStream2Mat_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    Axi2AxiStream_U0 : component gaussian_filter_accel_Axi2AxiStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AxiStream2Mat_U0 : component gaussian_filter_accel_AxiStream2Mat
    port map (
    ...
    ldata_U : component gaussian_filter_accel_fifo_w256_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    rows_c_U : component gaussian_filter_accel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_c_U : component gaussian_filter_accel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AxiStream2Mat_U0_U : component gaussian_filter_accel_start_for_AxiStream2Mat_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (AxiStream2Mat_U0_ap_ext_blocking_n and Axi2AxiStream_U0_ap_ext_blocking_n);
    ...
    ap_int_blocking_sub_n <= (AxiStream2Mat_U0_ap_int_blocking_n and Axi2AxiStream_U0_ap_int_blocking_n);
    ap_ready <= Axi2AxiStream_U0_ap_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (AxiStream2Mat_U0_ap_str_blocking_n and Axi2AxiStream_U0_ap_str_blocking_n);
    in_mat_data1_din <= AxiStream2Mat_U0_in_mat_data1_din;
    in_mat_data1_write <= AxiStream2Mat_U0_in_mat_data1_write;
    m_axi_gmem1_ARADDR <= Axi2AxiStream_U0_m_axi_gmem1_ARADDR;
    m_axi_gmem1_ARBURST <= Axi2AxiStream_U0_m_axi_gmem1_ARBURST;
