...
entity gaussian_filter_accel_xfMat2Array_256_0_2160_3840_1_2_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of gaussian_filter_accel_xfMat2Array_256_0_2160_3840_1_2_1_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_Mat2Axi_fu_62_out_mat_data2_read : STD_LOGIC;
    ...
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    component gaussian_filter_accel_Mat2Axi IS
    port (
        out_mat_data2_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        out_mat_data2_empty_n : IN STD_LOGIC;
        out_mat_data2_read : OUT STD_LOGIC;
...
begin
    grp_Mat2Axi_fu_62 : component gaussian_filter_accel_Mat2Axi
    port map (
    ...
    m_axi_gmem2_AWVALID_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem2_AWVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
    ...
    m_axi_gmem2_BREADY_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem2_BREADY, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem2_BREADY <= grp_Mat2Axi_fu_62_m_axi_gmem2_BREADY;
        else 
    ...
    m_axi_gmem2_WVALID_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem2_WVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem2_WVALID <= grp_Mat2Axi_fu_62_m_axi_gmem2_WVALID;
        else 
    ...
    out_mat_data2_read_assign_proc : process(grp_Mat2Axi_fu_62_out_mat_data2_read, ap_CS_fsm_state3)
    begin
