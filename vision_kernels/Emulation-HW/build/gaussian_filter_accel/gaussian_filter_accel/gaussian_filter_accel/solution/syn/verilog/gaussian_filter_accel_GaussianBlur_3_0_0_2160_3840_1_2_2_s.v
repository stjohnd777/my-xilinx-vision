...
wire    grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_48_1_fu_96_ap_ext_blocking_n;
wire    grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_48_1_fu_96_ap_str_blocking_n;
wire    grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_48_1_fu_96_ap_int_blocking_n;
...
wire    grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_58_2_fu_103_ap_ext_blocking_n;
wire    grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_58_2_fu_103_ap_str_blocking_n;
wire    grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_58_2_fu_103_ap_int_blocking_n;
...
wire    grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_ext_blocking_n;
wire    grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_str_blocking_n;
wire    grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_int_blocking_n;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state38))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state38))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_48_1_fu_96_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_58_2_fu_103_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_48_1_fu_96_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_58_2_fu_103_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_48_1_fu_96_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_GaussianBlur_3_0_0_2160_3840_1_2_2_Pipeline_VITIS_LOOP_58_2_fu_103_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xfGaussianFilter3x3_0_2160_3840_1_0_1_2_2_1_3840_s_fu_111_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((ap_ST_fsm_state38 == ap_CS_fsm)) begin
        ap_wait_2 = 1'b1;
    end else begin
        ap_wait_2 = 1'b0;
    end
...
assign ap_int_blocking_cur_n = (sigma_blk_n & p_src_rows_blk_n & p_src_cols_blk_n);
