set moduleName Array2xfMat_256_0_2160_3840_1_2_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {Array2xfMat<256, 0, 2160, 3840, 1, 2>}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Axi2Mat_fu_84.AxiStream2Mat_U0", "Parent" : "1", "Child" : ["7", "8", "9", "13", "14", "15"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "entry_proc6_U0", "Port" : "rows"}]},
			{"Name" : "cols", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["2"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "entry_proc6_U0", "Port" : "cols"}]}]},
	{"ID" : "7", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_Axi2Mat_fu_84.AxiStream2Mat_U0.entry_proc6_U0", "Parent" : "6",
		"CDFG" : "entry_proc6",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "12", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.grp_Axi2Mat_fu_84.AxiStream2Mat_U0.AxiStream2MatStream_2_U0.mul_32s_32s_32_1_1_U34", "Parent" : "9"},
