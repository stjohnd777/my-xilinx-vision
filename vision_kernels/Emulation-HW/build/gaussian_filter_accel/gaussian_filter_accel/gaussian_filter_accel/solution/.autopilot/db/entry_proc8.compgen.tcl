...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sigma_c \
    op interface \
    ports { sigma_c_din { O 32 vector } sigma_c_num_data_valid { I 3 vector } sigma_c_fifo_cap { I 3 vector } sigma_c_full_n { I 1 bit } sigma_c_write { O 1 bit } } \
} "
}
