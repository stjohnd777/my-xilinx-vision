...
module sobel_accel_AxiStream2Mat (
        ldata1_dout,
        ldata1_empty_n,
        ldata1_read,
        in_mat_data1_din,
...
sobel_accel_entry_proc9 entry_proc9_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_accel_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_ext_blocking_sub_n = (last_blk_pxl_width_U0_ap_ext_blocking_n & entry_proc9_U0_ap_ext_blocking_n & AxiStream2MatStream_2_U0_ap_ext_blocking_n);

assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc9_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (last_blk_pxl_width_U0_ap_int_blocking_n & entry_proc9_U0_ap_int_blocking_n & AxiStream2MatStream_2_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (last_blk_pxl_width_U0_ap_str_blocking_n & entry_proc9_U0_ap_str_blocking_n & AxiStream2MatStream_2_U0_ap_str_blocking_n);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_U0_ap_ready & ap_sync_entry_proc9_U0_ap_ready);
...
endmodule //sobel_accel_AxiStream2Mat
