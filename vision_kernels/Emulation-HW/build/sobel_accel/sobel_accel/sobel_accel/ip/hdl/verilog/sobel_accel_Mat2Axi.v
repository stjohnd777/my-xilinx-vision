...
module sobel_accel_Mat2Axi (
        p_dstgy_data3_dout,
        p_dstgy_data3_empty_n,
        p_dstgy_data3_read,
        m_axi_gmem3_AWVALID,
        m_axi_gmem3_AWREADY,
        m_axi_gmem3_AWADDR,
...
input  [7:0] p_dstgy_data3_dout;
input   p_dstgy_data3_empty_n;
output   p_dstgy_data3_read;
...
wire    entry_proc10_U0_ap_ext_blocking_n;
wire    entry_proc10_U0_ap_str_blocking_n;
wire    entry_proc10_U0_ap_int_blocking_n;
...
wire    Mat2AxiStream_U0_p_dstgx_data2_read;
...
sobel_accel_entry_proc10 entry_proc10_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_addrbound addrbound_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_Mat2Axi_Block_entry24_proc Mat2Axi_Block_entry24_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_Mat2AxiStream Mat2AxiStream_U0(
...
sobel_accel_AxiStream2Axi AxiStream2Axi_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
sobel_accel_fifo_w64_d4_S dout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_accel_fifo_w19_d2_S p_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_accel_fifo_w19_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
sobel_accel_fifo_w256_d2_S_x ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_ext_blocking_sub_n = (entry_proc10_U0_ap_ext_blocking_n & addrbound_U0_ap_ext_blocking_n & Mat2Axi_Block_entry24_proc_U0_ap_ext_blocking_n & Mat2AxiStream_U0_ap_ext_blocking_n & AxiStream2Axi_U0_ap_ext_blocking_n);

assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (p_channel_empty_n ^ 1'b1) & entry_proc10_U0_ap_idle & addrbound_U0_ap_idle & Mat2Axi_Block_entry24_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (entry_proc10_U0_ap_int_blocking_n & addrbound_U0_ap_int_blocking_n & Mat2Axi_Block_entry24_proc_U0_ap_int_blocking_n & Mat2AxiStream_U0_ap_int_blocking_n & AxiStream2Axi_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (entry_proc10_U0_ap_str_blocking_n & addrbound_U0_ap_str_blocking_n & Mat2Axi_Block_entry24_proc_U0_ap_str_blocking_n & Mat2AxiStream_U0_ap_str_blocking_n & AxiStream2Axi_U0_ap_str_blocking_n);
...
assign ap_sync_ready = (ap_sync_entry_proc10_U0_ap_ready & ap_sync_addrbound_U0_ap_ready & ap_sync_Mat2AxiStream_U0_ap_ready);
...
assign p_dstgy_data3_read = Mat2AxiStream_U0_p_dstgx_data2_read;

endmodule //sobel_accel_Mat2Axi
