...
entity sobel_accel_xfMat2Array_256_0_2160_3840_1_2_1_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of sobel_accel_xfMat2Array_256_0_2160_3840_1_2_1_2 is 
...
attribute shreg_extract : string;
    ...
    signal grp_Mat2Axi_fu_62_p_dstgy_data3_read : STD_LOGIC;
    ...
    signal grp_Mat2Axi_fu_62_m_axi_gmem3_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal grp_Mat2Axi_fu_62_m_axi_gmem3_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_Mat2Axi_fu_62_ap_ext_blocking_n : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_ap_str_blocking_n : STD_LOGIC;
    signal grp_Mat2Axi_fu_62_ap_int_blocking_n : STD_LOGIC;
    ...
    component sobel_accel_Mat2Axi IS
    port (
        p_dstgy_data3_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        p_dstgy_data3_empty_n : IN STD_LOGIC;
        p_dstgy_data3_read : OUT STD_LOGIC;
...
begin
    grp_Mat2Axi_fu_62 : component sobel_accel_Mat2Axi
    port map (
        p_dstgy_data3_dout => p_dstgy_data3_dout,
        p_dstgy_data3_empty_n => p_dstgy_data3_empty_n,
        p_dstgy_data3_read => grp_Mat2Axi_fu_62_p_dstgy_data3_read,
    ...
    ap_sub_ext_blocking_0_assign_proc : process(grp_Mat2Axi_fu_62_ap_ext_blocking_n)
    begin
        if ((grp_Mat2Axi_fu_62_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_0_assign_proc : process(grp_Mat2Axi_fu_62_ap_int_blocking_n)
    begin
        if ((grp_Mat2Axi_fu_62_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_0_assign_proc : process(grp_Mat2Axi_fu_62_ap_str_blocking_n)
    begin
        if ((grp_Mat2Axi_fu_62_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    m_axi_gmem3_AWVALID_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem3_AWVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
    ...
    m_axi_gmem3_BREADY_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem3_BREADY, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem3_BREADY <= grp_Mat2Axi_fu_62_m_axi_gmem3_BREADY;
        else 
    ...
    m_axi_gmem3_WVALID_assign_proc : process(grp_Mat2Axi_fu_62_m_axi_gmem3_WVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem3_WVALID <= grp_Mat2Axi_fu_62_m_axi_gmem3_WVALID;
        else 
    ...
    p_dstgy_data3_read_assign_proc : process(grp_Mat2Axi_fu_62_p_dstgy_data3_read, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            p_dstgy_data3_read <= grp_Mat2Axi_fu_62_p_dstgy_data3_read;
        else 
            p_dstgy_data3_read <= ap_const_logic_0;
        end if; 
    end process;
