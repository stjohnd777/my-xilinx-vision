...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_accel_fifo_w64_d4_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {dout_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_accel_fifo_w19_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {p_channel_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_accel_fifo_w19_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {axibound_V_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_accel_fifo_w256_d2_S_x BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {ldata_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dstgy_data3_dout { I 8 vector } p_dstgy_data3_empty_n { I 1 bit } p_dstgy_data3_read { O 1 bit } } \
} "
}
