...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "7", "8", "9"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "p_dstgx_data2"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_2_U0", "Parent" : "0", "Child" : ["4", "6"],
		...
		"Port" : [
			{"Name" : "p_dstgx_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "p_dstgx_data2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_2_U0.mul_mul_16ns_16ns_32_4_1_U141", "Parent" : "3"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10", "Max" : "8294409"}
	, {"Name" : "Interval", "Min" : "10", "Max" : "8294409"}
]}
...
set Spec2ImplPortList { 
	p_dstgx_data2 { ap_fifo {  { p_dstgx_data2_dout fifo_port_we 0 8 }  { p_dstgx_data2_empty_n fifo_status 0 1 }  { p_dstgx_data2_read fifo_data 1 1 } } }
