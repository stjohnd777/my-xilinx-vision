...
set C_modelArgList {
	...
	{ p_dstgx_data2 int 8 regular {fifo 0 volatile }  }
	{ ldata1 int 256 regular {fifo 1 volatile }  }
	{ localbuffer_V_3_out int 256 regular {pointer 1}  }
	{ filled_V_1_out int 9 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_dstgx_data2", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "ldata1", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	{ "Name" : "localbuffer_V_3_out", "interface" : "wire", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
 	{ "Name" : "filled_V_1_out", "interface" : "wire", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_dstgx_data2_dout sc_in sc_lv 8 signal 5 } 
	{ p_dstgx_data2_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ p_dstgx_data2_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ p_dstgx_data2_empty_n sc_in sc_logic 1 signal 5 } 
	{ p_dstgx_data2_read sc_out sc_logic 1 signal 5 } 
	{ ldata1_din sc_out sc_lv 256 signal 6 } 
	...
	{ localbuffer_V_3_out sc_out sc_lv 256 signal 7 } 
	{ localbuffer_V_3_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ filled_V_1_out sc_out sc_lv 9 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_dstgx_data2_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "p_dstgx_data2", "role": "dout" }} , 
 	...
 	{ "name": "p_dstgx_data2_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_dstgx_data2", "role": "empty_n" }} , 
 	{ "name": "p_dstgx_data2_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "p_dstgx_data2", "role": "read" }} , 
 	{ "name": "ldata1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "ldata1", "role": "din" }} , 
 	...
 	{ "name": "localbuffer_V_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "localbuffer_V_3_out", "role": "default" }} , 
 	...
 	{ "name": "filled_V_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "filled_V_1_out", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "8294403"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "8294403"}
]}
...
set Spec2ImplPortList { 
	...
	p_dstgx_data2 { ap_fifo {  { p_dstgx_data2_dout fifo_port_we 0 8 }  { p_dstgx_data2_num_data_valid fifo_status_num_data_valid 0 2 }  { p_dstgx_data2_fifo_cap fifo_update 0 2 }  { p_dstgx_data2_empty_n fifo_status 0 1 }  { p_dstgx_data2_read fifo_data 1 1 } } }
	ldata1 { ap_fifo {  { ldata1_din fifo_port_we 1 256 }  { ldata1_num_data_valid fifo_status_num_data_valid 0 2 }  { ldata1_fifo_cap fifo_update 0 2 }  { ldata1_full_n fifo_status 0 1 }  { ldata1_write fifo_data 1 1 } } }
	localbuffer_V_3_out { ap_vld {  { localbuffer_V_3_out out_data 1 256 }  { localbuffer_V_3_out_ap_vld out_vld 1 1 } } }
	filled_V_1_out { ap_vld {  { filled_V_1_out out_data 1 9 }  { filled_V_1_out_ap_vld out_vld 1 1 } } }
}
