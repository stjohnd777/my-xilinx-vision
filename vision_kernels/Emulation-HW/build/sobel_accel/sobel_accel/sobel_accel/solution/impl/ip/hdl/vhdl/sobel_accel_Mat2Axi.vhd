...
architecture behav of sobel_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc10_U0_ap_ext_blocking_n : STD_LOGIC;
    signal entry_proc10_U0_ap_str_blocking_n : STD_LOGIC;
    signal entry_proc10_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    signal Mat2AxiStream_U0_p_dstgx_data2_read : STD_LOGIC;
    signal Mat2AxiStream_U0_ldata1_din : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal AxiStream2Axi_U0_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (255 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ldata_dout : STD_LOGIC_VECTOR (255 downto 0);
    ...
    component sobel_accel_entry_proc10 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_Mat2Axi_Block_entry24_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_Mat2AxiStream IS
    port (
    ...
    component sobel_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component sobel_accel_fifo_w19_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component sobel_accel_fifo_w256_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc10_U0 : component sobel_accel_entry_proc10
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_ext_blocking_n => entry_proc10_U0_ap_ext_blocking_n,
        ap_str_blocking_n => entry_proc10_U0_ap_str_blocking_n,
        ap_int_blocking_n => entry_proc10_U0_ap_int_blocking_n);

    addrbound_U0 : component sobel_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_entry24_proc_U0 : component sobel_accel_Mat2Axi_Block_entry24_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component sobel_accel_Mat2AxiStream
    port map (
        p_dstgx_data2_dout => p_dstgy_data3_dout,
        p_dstgx_data2_empty_n => p_dstgy_data3_empty_n,
        p_dstgx_data2_read => Mat2AxiStream_U0_p_dstgx_data2_read,
    ...
    AxiStream2Axi_U0 : component sobel_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component sobel_accel_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    p_channel_U : component sobel_accel_fifo_w19_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component sobel_accel_fifo_w19_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component sobel_accel_fifo_w256_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (entry_proc10_U0_ap_ext_blocking_n and addrbound_U0_ap_ext_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_ext_blocking_n and Mat2AxiStream_U0_ap_ext_blocking_n and AxiStream2Axi_U0_ap_ext_blocking_n);
    ap_idle <= ((axibound_V_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and entry_proc10_U0_ap_idle and addrbound_U0_ap_idle and Mat2Axi_Block_entry24_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (entry_proc10_U0_ap_int_blocking_n and addrbound_U0_ap_int_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_int_blocking_n and Mat2AxiStream_U0_ap_int_blocking_n and AxiStream2Axi_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (entry_proc10_U0_ap_str_blocking_n and addrbound_U0_ap_str_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_str_blocking_n and Mat2AxiStream_U0_ap_str_blocking_n and AxiStream2Axi_U0_ap_str_blocking_n);
    ...
    ap_sync_ready <= (ap_sync_entry_proc10_U0_ap_ready and ap_sync_addrbound_U0_ap_ready and ap_sync_Mat2AxiStream_U0_ap_ready);
    ...
    m_axi_gmem3_AWADDR <= AxiStream2Axi_U0_m_axi_gmem2_AWADDR;
    m_axi_gmem3_AWBURST <= AxiStream2Axi_U0_m_axi_gmem2_AWBURST;
    m_axi_gmem3_AWCACHE <= AxiStream2Axi_U0_m_axi_gmem2_AWCACHE;
    m_axi_gmem3_AWID <= AxiStream2Axi_U0_m_axi_gmem2_AWID;
    m_axi_gmem3_AWLEN <= AxiStream2Axi_U0_m_axi_gmem2_AWLEN;
    m_axi_gmem3_AWLOCK <= AxiStream2Axi_U0_m_axi_gmem2_AWLOCK;
    m_axi_gmem3_AWPROT <= AxiStream2Axi_U0_m_axi_gmem2_AWPROT;
    m_axi_gmem3_AWQOS <= AxiStream2Axi_U0_m_axi_gmem2_AWQOS;
    m_axi_gmem3_AWREGION <= AxiStream2Axi_U0_m_axi_gmem2_AWREGION;
    m_axi_gmem3_AWSIZE <= AxiStream2Axi_U0_m_axi_gmem2_AWSIZE;
    m_axi_gmem3_AWUSER <= AxiStream2Axi_U0_m_axi_gmem2_AWUSER;
    m_axi_gmem3_AWVALID <= AxiStream2Axi_U0_m_axi_gmem2_AWVALID;
    m_axi_gmem3_BREADY <= AxiStream2Axi_U0_m_axi_gmem2_BREADY;
    m_axi_gmem3_RREADY <= ap_const_logic_0;
    m_axi_gmem3_WDATA <= AxiStream2Axi_U0_m_axi_gmem2_WDATA;
    m_axi_gmem3_WID <= AxiStream2Axi_U0_m_axi_gmem2_WID;
    m_axi_gmem3_WLAST <= AxiStream2Axi_U0_m_axi_gmem2_WLAST;
    m_axi_gmem3_WSTRB <= AxiStream2Axi_U0_m_axi_gmem2_WSTRB;
    m_axi_gmem3_WUSER <= AxiStream2Axi_U0_m_axi_gmem2_WUSER;
    m_axi_gmem3_WVALID <= AxiStream2Axi_U0_m_axi_gmem2_WVALID;
    p_dstgy_data3_read <= Mat2AxiStream_U0_p_dstgx_data2_read;
end behav;
