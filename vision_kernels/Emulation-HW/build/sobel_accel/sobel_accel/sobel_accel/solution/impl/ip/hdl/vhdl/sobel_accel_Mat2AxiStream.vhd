...
entity sobel_accel_Mat2AxiStream is
port (
...
architecture behav of sobel_accel_Mat2AxiStream is 
...
attribute shreg_extract : string;
    ...
    signal MatStream2AxiStream_2_U0_p_dstgx_data2_read : STD_LOGIC;
    signal MatStream2AxiStream_2_U0_ldata1_din : STD_LOGIC_VECTOR (255 downto 0);
    ...
    component sobel_accel_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_last_blk_pxl_width_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_MatStream2AxiStream_2_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component sobel_accel_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component sobel_accel_fifo_w32_d3_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component sobel_accel_fifo_w4_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component sobel_accel_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_1_U0 : component sobel_accel_last_blk_pxl_width_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MatStream2AxiStream_2_U0 : component sobel_accel_MatStream2AxiStream_2_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        p_dstgx_data2_read => MatStream2AxiStream_2_U0_p_dstgx_data2_read,
    ...
    rows_c_U : component sobel_accel_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component sobel_accel_fifo_w32_d3_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    last_blk_width_channel_U : component sobel_accel_fifo_w4_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (last_blk_pxl_width_1_U0_ap_ext_blocking_n and entry_proc_U0_ap_ext_blocking_n and MatStream2AxiStream_2_U0_ap_ext_blocking_n);
    ...
    ap_int_blocking_sub_n <= (last_blk_pxl_width_1_U0_ap_int_blocking_n and entry_proc_U0_ap_int_blocking_n and MatStream2AxiStream_2_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (last_blk_pxl_width_1_U0_ap_str_blocking_n and entry_proc_U0_ap_str_blocking_n and MatStream2AxiStream_2_U0_ap_str_blocking_n);
