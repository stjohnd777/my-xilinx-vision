...
wire    call_ret_xFSobel3x3_1_1_0_0_s_fu_268_ap_ext_blocking_n;
wire    call_ret_xFSobel3x3_1_1_0_0_s_fu_268_ap_str_blocking_n;
wire    call_ret_xFSobel3x3_1_1_0_0_s_fu_268_ap_int_blocking_n;
...
always @ (*) begin
    if ((call_ret_xFSobel3x3_1_1_0_0_s_fu_268_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((call_ret_xFSobel3x3_1_1_0_0_s_fu_268_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((call_ret_xFSobel3x3_1_1_0_0_s_fu_268_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    ap_condition_261 = ((1'b0 == ap_block_pp0_stage0) & (icmp_ln1027_reg_542 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_condition_470 = (~(bottom_V_read_reg_521 == 2'd0) & ~(bottom_V_read_reg_521 == 2'd1) & (cmp_i_i603_i_read_reg_513 == 1'd0));
end

always @ (*) begin
    ap_condition_474 = (~(row_ind_V_cast_read_reg_517 == 2'd0) & ~(row_ind_V_cast_read_reg_517 == 2'd1) & (cmp_i_i603_i == 1'd1));
end
...
assign ap_int_blocking_cur_n = (p_dstgy_data3_blk_n & p_dstgx_data2_blk_n & in_mat_data1_blk_n);
