...
attribute shreg_extract : string;
    ...
    signal entry_proc17_U0_dout_c_din : STD_LOGIC_VECTOR (63 downto 0);
    signal entry_proc17_U0_dout_c_write : STD_LOGIC;
    signal entry_proc17_U0_ap_ext_blocking_n : STD_LOGIC;
    signal entry_proc17_U0_ap_str_blocking_n : STD_LOGIC;
    signal entry_proc17_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    signal addrbound_U0_rows_2 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal axibound_V_1_channel_full_n : STD_LOGIC;
    ...
    signal Mat2Axi_Block_entry13_proc_U0_ap_return : STD_LOGIC_VECTOR (16 downto 0);
    signal Mat2Axi_Block_entry13_proc_U0_ap_ext_blocking_n : STD_LOGIC;
    signal Mat2Axi_Block_entry13_proc_U0_ap_str_blocking_n : STD_LOGIC;
    signal Mat2Axi_Block_entry13_proc_U0_ap_int_blocking_n : STD_LOGIC;
    signal axibound_V_full_n : STD_LOGIC;
    signal Mat2AxiStream_U0_dst_mat_data2_read : STD_LOGIC;
    ...
    signal axibound_V_1_channel_dout : STD_LOGIC_VECTOR (16 downto 0);
    signal axibound_V_1_channel_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal axibound_V_1_channel_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal axibound_V_1_channel_empty_n : STD_LOGIC;
    signal axibound_V_dout : STD_LOGIC_VECTOR (16 downto 0);
    ...
    component canny_accel_entry_proc17 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        rows_2 : OUT STD_LOGIC_VECTOR (16 downto 0);
        rows : IN STD_LOGIC_VECTOR (15 downto 0);
        cols : IN STD_LOGIC_VECTOR (10 downto 0);
        ap_ext_blocking_n : OUT STD_LOGIC;
        ap_str_blocking_n : OUT STD_LOGIC;
    ...
    component canny_accel_Mat2Axi_Block_entry13_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_V_1 : IN STD_LOGIC_VECTOR (16 downto 0);
    ...
    component canny_accel_fifo_w17_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc17_U0 : component canny_accel_entry_proc17
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        dout => dout,
        dout_c_din => entry_proc17_U0_dout_c_din,
        dout_c_num_data_valid => dout_c_num_data_valid,
        dout_c_fifo_cap => dout_c_fifo_cap,
        dout_c_full_n => dout_c_full_n,
        dout_c_write => entry_proc17_U0_dout_c_write,
        ap_ext_blocking_n => entry_proc17_U0_ap_ext_blocking_n,
        ap_str_blocking_n => entry_proc17_U0_ap_str_blocking_n,
        ap_int_blocking_n => entry_proc17_U0_ap_int_blocking_n);
    ...
    Mat2Axi_Block_entry13_proc_U0 : component canny_accel_Mat2Axi_Block_entry13_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        axibound_V_1 => axibound_V_1_channel_dout,
        ap_return => Mat2Axi_Block_entry13_proc_U0_ap_return,
        ap_ext_blocking_n => Mat2Axi_Block_entry13_proc_U0_ap_ext_blocking_n,
        ap_str_blocking_n => Mat2Axi_Block_entry13_proc_U0_ap_str_blocking_n,
        ap_int_blocking_n => Mat2Axi_Block_entry13_proc_U0_ap_int_blocking_n);
    ...
    port map (
        ...
        dst_mat_data2_read => Mat2AxiStream_U0_dst_mat_data2_read,
    ...
    port map (
        ...
        if_din => entry_proc17_U0_dout_c_din,
        if_full_n => dout_c_full_n,
        if_write => entry_proc17_U0_dout_c_write,
        if_dout => dout_c_dout,
    ...
    axibound_V_1_channel_U : component canny_accel_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => axibound_V_1_channel_full_n,
        if_write => addrbound_U0_ap_done,
        if_dout => axibound_V_1_channel_dout,
        if_num_data_valid => axibound_V_1_channel_num_data_valid,
        if_fifo_cap => axibound_V_1_channel_fifo_cap,
        if_empty_n => axibound_V_1_channel_empty_n,
        if_read => Mat2Axi_Block_entry13_proc_U0_ap_ready);

    axibound_V_U : component canny_accel_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component canny_accel_fifo_w64_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    Mat2Axi_Block_entry13_proc_U0_ap_continue <= axibound_V_full_n;
    Mat2Axi_Block_entry13_proc_U0_ap_start <= axibound_V_1_channel_empty_n;
    addrbound_U0_ap_continue <= axibound_V_1_channel_full_n;
    ...
    ap_ext_blocking_sub_n <= (entry_proc17_U0_ap_ext_blocking_n and addrbound_U0_ap_ext_blocking_n and Mat2Axi_Block_entry13_proc_U0_ap_ext_blocking_n and Mat2AxiStream_U0_ap_ext_blocking_n and AxiStream2Axi_U0_ap_ext_blocking_n);
    ap_idle <= ((axibound_V_empty_n xor ap_const_logic_1) and (axibound_V_1_channel_empty_n xor ap_const_logic_1) and entry_proc17_U0_ap_idle and addrbound_U0_ap_idle and Mat2Axi_Block_entry13_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (entry_proc17_U0_ap_int_blocking_n and addrbound_U0_ap_int_blocking_n and Mat2Axi_Block_entry13_proc_U0_ap_int_blocking_n and Mat2AxiStream_U0_ap_int_blocking_n and AxiStream2Axi_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (entry_proc17_U0_ap_str_blocking_n and addrbound_U0_ap_str_blocking_n and Mat2Axi_Block_entry13_proc_U0_ap_str_blocking_n and Mat2AxiStream_U0_ap_str_blocking_n and AxiStream2Axi_U0_ap_str_blocking_n);
    ...
    ap_sync_ready <= (ap_sync_entry_proc17_U0_ap_ready and ap_sync_addrbound_U0_ap_ready and ap_sync_Mat2AxiStream_U0_ap_ready);
    dst_mat_data2_read <= Mat2AxiStream_U0_dst_mat_data2_read;
