...
wire   [63:0] entry_proc17_U0_dout_c_din;
wire    entry_proc17_U0_dout_c_write;
wire    entry_proc17_U0_ap_ext_blocking_n;
wire    entry_proc17_U0_ap_str_blocking_n;
wire    entry_proc17_U0_ap_int_blocking_n;
...
wire   [16:0] Mat2Axi_Block_entry13_proc_U0_ap_return;
wire    Mat2Axi_Block_entry13_proc_U0_ap_ext_blocking_n;
wire    Mat2Axi_Block_entry13_proc_U0_ap_str_blocking_n;
wire    Mat2Axi_Block_entry13_proc_U0_ap_int_blocking_n;
wire    axibound_V_full_n;
wire    Mat2AxiStream_U0_dst_mat_data2_read;
...
wire    dout_c_empty_n;
wire   [16:0] axibound_V_1_channel_dout;
wire   [1:0] axibound_V_1_channel_num_data_valid;
wire   [1:0] axibound_V_1_channel_fifo_cap;
wire    axibound_V_1_channel_empty_n;
wire   [16:0] axibound_V_dout;
...
canny_accel_entry_proc17 entry_proc17_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
canny_accel_Mat2Axi_Block_entry13_proc Mat2Axi_Block_entry13_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
canny_accel_fifo_w17_d2_S axibound_V_1_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
canny_accel_fifo_w17_d2_S axibound_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
canny_accel_fifo_w64_d2_S_x ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Mat2Axi_Block_entry13_proc_U0_ap_continue = axibound_V_full_n;

assign Mat2Axi_Block_entry13_proc_U0_ap_start = axibound_V_1_channel_empty_n;

assign addrbound_U0_ap_continue = axibound_V_1_channel_full_n;
...
assign ap_ext_blocking_sub_n = (entry_proc17_U0_ap_ext_blocking_n & addrbound_U0_ap_ext_blocking_n & Mat2Axi_Block_entry13_proc_U0_ap_ext_blocking_n & Mat2AxiStream_U0_ap_ext_blocking_n & AxiStream2Axi_U0_ap_ext_blocking_n);

assign ap_idle = ((axibound_V_empty_n ^ 1'b1) & (axibound_V_1_channel_empty_n ^ 1'b1) & entry_proc17_U0_ap_idle & addrbound_U0_ap_idle & Mat2Axi_Block_entry13_proc_U0_ap_idle & Mat2AxiStream_U0_ap_idle & AxiStream2Axi_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (entry_proc17_U0_ap_int_blocking_n & addrbound_U0_ap_int_blocking_n & Mat2Axi_Block_entry13_proc_U0_ap_int_blocking_n & Mat2AxiStream_U0_ap_int_blocking_n & AxiStream2Axi_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (entry_proc17_U0_ap_str_blocking_n & addrbound_U0_ap_str_blocking_n & Mat2Axi_Block_entry13_proc_U0_ap_str_blocking_n & Mat2AxiStream_U0_ap_str_blocking_n & AxiStream2Axi_U0_ap_str_blocking_n);
...
assign ap_sync_ready = (ap_sync_entry_proc17_U0_ap_ready & ap_sync_addrbound_U0_ap_ready & ap_sync_Mat2AxiStream_U0_ap_ready);

assign dst_mat_data2_read = Mat2AxiStream_U0_dst_mat_data2_read;
