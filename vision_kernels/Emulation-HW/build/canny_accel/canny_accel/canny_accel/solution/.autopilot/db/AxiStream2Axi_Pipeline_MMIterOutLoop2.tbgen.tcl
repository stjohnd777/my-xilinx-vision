...
set C_modelArgList {
	...
	{ sext_ln1380 int 61 regular  }
	{ p_read int 17 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "img_out","offset": { "type": "dynamic","port_name": "img_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln1380", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem2_WDATA sc_out sc_lv 64 signal 0 } 
	{ m_axi_gmem2_WSTRB sc_out sc_lv 8 signal 0 } 
	...
	{ m_axi_gmem2_RDATA sc_in sc_lv 64 signal 0 } 
	...
	{ sext_ln1380 sc_in sc_lv 61 signal 1 } 
	{ p_read sc_in sc_lv 17 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1380", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln1380", "role": "default" }} , 
 	{ "name": "p_read", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "p_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1380 { ap_none {  { sext_ln1380 in_data 0 61 } } }
	p_read { ap_none {  { p_read in_data 0 17 } } }
