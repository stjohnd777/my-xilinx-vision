...
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sub3", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln1075", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ldata1_dout sc_in sc_lv 64 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ldata1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "ldata1", "role": "dout" }} , 
 	...
 	{ "name": "sext_ln1075", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "sext_ln1075", "role": "default" }} , 
 	...
 	{ "name": "sub3", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "sub3", "role": "default" }} , 
 	{ "name": "add_ln1075", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "add_ln1075", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1075 { ap_none {  { sext_ln1075 in_data 0 5 } } }
	cols_bound_per_npc_load { ap_none {  { cols_bound_per_npc_load in_data 0 32 } } }
	ldata1 { ap_fifo {  { ldata1_dout fifo_port_we 0 64 }  { ldata1_num_data_valid fifo_status_num_data_valid 0 2 }  { ldata1_fifo_cap fifo_update 0 2 }  { ldata1_empty_n fifo_status 0 1 }  { ldata1_read fifo_data 1 1 } } }
	sub { ap_none {  { sub in_data 0 32 } } }
	last_blk_width_load { ap_none {  { last_blk_width_load in_data 0 4 } } }
	sub3 { ap_none {  { sub3 in_data 0 7 } } }
	add_ln1075 { ap_none {  { add_ln1075 in_data 0 7 } } }
