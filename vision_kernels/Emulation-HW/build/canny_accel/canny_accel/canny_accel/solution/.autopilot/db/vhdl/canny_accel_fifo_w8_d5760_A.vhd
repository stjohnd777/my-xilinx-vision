...
entity canny_accel_fifo_w8_d5760_A is
    generic (
...
architecture arch of canny_accel_fifo_w8_d5760_A is

    -- component
    component canny_accel_fifo_w8_d5760_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_canny_accel_fifo_w8_d5760_A_ram : canny_accel_fifo_w8_d5760_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity canny_accel_fifo_w8_d5760_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 8;
        ADDR_WIDTH  : integer := 13;
...
architecture arch of canny_accel_fifo_w8_d5760_A_ram is
