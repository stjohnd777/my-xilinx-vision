...
set C_modelArgList {
	...
	{ din int 64 regular  }
	{ ldata int 64 regular {fifo 1 volatile }  }
	{ rows int 32 regular  }
	{ cols int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_inp","offset": { "type": "dynamic","port_name": "img_inp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "ldata", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ ldata_din sc_out sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ldata_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "ldata", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "78", "Max" : "317"}
	, {"Name" : "Interval", "Min" : "78", "Max" : "317"}
]}
...
set Spec2ImplPortList { 
	...
	ldata { ap_fifo {  { ldata_din fifo_port_we 1 64 }  { ldata_num_data_valid fifo_status_num_data_valid 0 2 }  { ldata_fifo_cap fifo_update 0 2 }  { ldata_full_n fifo_status 0 1 }  { ldata_write fifo_data 1 1 } } }
