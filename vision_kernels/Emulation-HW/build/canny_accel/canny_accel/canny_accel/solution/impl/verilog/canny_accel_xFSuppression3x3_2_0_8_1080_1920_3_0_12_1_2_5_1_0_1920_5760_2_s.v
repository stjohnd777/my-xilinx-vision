...
wire    grp_xFSuppression3x3_Pipeline_bufColLoop_fu_219_ap_ext_blocking_n;
wire    grp_xFSuppression3x3_Pipeline_bufColLoop_fu_219_ap_str_blocking_n;
wire    grp_xFSuppression3x3_Pipeline_bufColLoop_fu_219_ap_int_blocking_n;
...
wire    grp_xFSuppression3x3_Pipeline_colLoop1_fu_231_ap_ext_blocking_n;
wire    grp_xFSuppression3x3_Pipeline_colLoop1_fu_231_ap_str_blocking_n;
wire    grp_xFSuppression3x3_Pipeline_colLoop1_fu_231_ap_int_blocking_n;
...
always @ (*) begin
    if ((grp_xFSuppression3x3_Pipeline_bufColLoop_fu_219_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFSuppression3x3_Pipeline_colLoop1_fu_231_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFSuppression3x3_Pipeline_bufColLoop_fu_219_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFSuppression3x3_Pipeline_colLoop1_fu_231_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFSuppression3x3_Pipeline_bufColLoop_fu_219_ap_str_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFSuppression3x3_Pipeline_colLoop1_fu_231_ap_str_blocking_n == 1'b0)) begin
...
assign ap_int_blocking_cur_n = (nms_mat_data10_blk_n & low_threshold_blk_n & imgwidth_blk_n & imgheight_blk_n & img_width_c_blk_n & img_height_c_blk_n & high_threshold_blk_n);
