...
attribute shreg_extract : string;
    ...
    signal trunc_ln_reg_113 : STD_LOGIC_VECTOR (60 downto 0);
    ...
    signal grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_m_axi_gmem2_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_m_axi_gmem2_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component canny_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        m_axi_gmem2_BID : IN STD_LOGIC_VECTOR (0 downto 0);
        m_axi_gmem2_BUSER : IN STD_LOGIC_VECTOR (0 downto 0);
        sext_ln1380 : IN STD_LOGIC_VECTOR (60 downto 0);
        p_read : IN STD_LOGIC_VECTOR (16 downto 0);
        ap_ext_blocking_n : OUT STD_LOGIC;
        ap_str_blocking_n : OUT STD_LOGIC;
        ap_int_blocking_n : OUT STD_LOGIC );
...
begin
    grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73 : component canny_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                trunc_ln_reg_113 <= dout_dout(63 downto 3);
            end if;
        end if;
    end process;
