...
set C_modelArgList {
	...
	{ ldata1 int 8 regular {fifo 1 volatile }  }
	{ localbuffer_V_3_out int 8 regular {pointer 1}  }
	{ filled_V_1_out int 4 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ldata1", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "localbuffer_V_3_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "filled_V_1_out", "interface" : "wire", "bitwidth" : 4, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ imgOutput_data4_dout sc_in sc_lv 8 signal 5 } 
	{ imgOutput_data4_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ imgOutput_data4_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ imgOutput_data4_empty_n sc_in sc_logic 1 signal 5 } 
	{ imgOutput_data4_read sc_out sc_logic 1 signal 5 } 
	{ ldata1_din sc_out sc_lv 8 signal 6 } 
	...
	{ localbuffer_V_3_out sc_out sc_lv 8 signal 7 } 
	{ localbuffer_V_3_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ filled_V_1_out sc_out sc_lv 4 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ldata1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "ldata1", "role": "din" }} , 
 	...
 	{ "name": "localbuffer_V_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "localbuffer_V_3_out", "role": "default" }} , 
 	...
 	{ "name": "filled_V_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "filled_V_1_out", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "2073602"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "2073602"}
]}
...
set Spec2ImplPortList { 
	...
	ldata1 { ap_fifo {  { ldata1_din fifo_port_we 1 8 }  { ldata1_num_data_valid fifo_status_num_data_valid 0 2 }  { ldata1_fifo_cap fifo_update 0 2 }  { ldata1_full_n fifo_status 0 1 }  { ldata1_write fifo_data 1 1 } } }
	localbuffer_V_3_out { ap_vld {  { localbuffer_V_3_out out_data 1 8 }  { localbuffer_V_3_out_ap_vld out_vld 1 1 } } }
	filled_V_1_out { ap_vld {  { filled_V_1_out out_data 1 4 }  { filled_V_1_out_ap_vld out_vld 1 1 } } }
}
