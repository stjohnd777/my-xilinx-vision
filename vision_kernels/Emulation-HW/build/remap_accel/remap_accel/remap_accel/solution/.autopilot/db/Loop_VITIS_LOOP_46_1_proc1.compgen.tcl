...
set id 12
set name remap_accel_mul_mul_11ns_11ns_22_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mapX_data \
    op interface \
    ports { mapX_data_din { O 32 vector } mapX_data_num_data_valid { I 2 vector } mapX_data_fifo_cap { I 2 vector } mapX_data_full_n { I 1 bit } mapX_data_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mapY_data \
    op interface \
    ports { mapY_data_din { O 32 vector } mapY_data_num_data_valid { I 2 vector } mapY_data_fifo_cap { I 2 vector } mapY_data_full_n { I 1 bit } mapY_data_write { O 1 bit } } \
} "
}
