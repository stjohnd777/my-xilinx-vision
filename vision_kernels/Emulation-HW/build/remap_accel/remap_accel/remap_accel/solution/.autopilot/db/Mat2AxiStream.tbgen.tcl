...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "7", "8", "9"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "MatStream2AxiStream_2_U0", "Port" : "imgOutput_data4"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_2_U0", "Parent" : "0", "Child" : ["4", "6"],
		...
		"Port" : [
			{"Name" : "imgOutput_data4", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput_data4", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.MatStream2AxiStream_2_U0.mul_mul_16ns_16ns_32_4_1_U168", "Parent" : "3"},
...
set Spec2ImplPortList { 
	...
	ldata1 { ap_fifo {  { ldata1_din fifo_port_we 1 8 }  { ldata1_full_n fifo_status 0 1 }  { ldata1_write fifo_data 1 1 } } }
