set moduleName image_thresholding_kernel00_Pipeline_VITIS_LOOP_11_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {image_thresholding_kernel00_Pipeline_VITIS_LOOP_11_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 2}  }
	{ output_image int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "input_image","offset": { "type": "dynamic","port_name": "input_image","bundle": "control"},"direction": "READONLY"},{"cName": "output_image","offset": { "type": "dynamic","port_name": "output_image","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "output_image", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_image sc_in sc_lv 64 signal 1 } 
	{ input_image sc_in sc_lv 64 signal 2 } 
	{ mul sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_image", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "output_image", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	output_image { ap_none {  { output_image in_data 0 64 } } }
