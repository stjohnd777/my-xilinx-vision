...
entity threshold_accel_MatStream2AxiStream_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of threshold_accel_MatStream2AxiStream_1_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_idle : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ready : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_out_mat_data2_read : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata1_din : STD_LOGIC_VECTOR (255 downto 0);
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata1_write : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_V_3_out : STD_LOGIC_VECTOR (255 downto 0);
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_V_3_out_ap_vld : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_filled_V_1_out : STD_LOGIC_VECTOR (8 downto 0);
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_filled_V_1_out_ap_vld : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ext_blocking_n : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_str_blocking_n : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_int_blocking_n : STD_LOGIC;
    signal grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start_reg : STD_LOGIC := '0';
    ...
    component threshold_accel_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_mul_mul_16ns_16ns_32_4_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79 : component threshold_accel_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start,
        ap_done => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done,
        ap_idle => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_idle,
        ap_ready => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ready,
        ...
        out_mat_data2_read => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_out_mat_data2_read,
        ldata1_din => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata1_din,
        ldata1_num_data_valid => ap_const_lv2_0,
        ldata1_fifo_cap => ap_const_lv2_0,
        ldata1_full_n => ldata1_full_n,
        ldata1_write => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata1_write,
        bound => bound_reg_175,
        ...
        localbuffer_V_3_out => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_V_3_out,
        localbuffer_V_3_out_ap_vld => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_V_3_out_ap_vld,
        filled_V_1_out => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_filled_V_1_out,
        filled_V_1_out_ap_vld => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_filled_V_1_out_ap_vld,
        ap_ext_blocking_n => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ext_blocking_n,
        ap_str_blocking_n => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_str_blocking_n,
        ap_int_blocking_n => grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_int_blocking_n);

    mul_mul_16ns_16ns_32_4_1_U98 : component threshold_accel_mul_mul_16ns_16ns_32_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state4)) then 
                    grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ready = ap_const_logic_1)) then 
                    grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ldata1_full_n, rows_empty_n, cols_bound_per_npc_empty_n, ap_CS_fsm_state6, icmp_ln1023_fu_119_p2, grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done, ap_CS_fsm_state5)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state5 => 
                if (((grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
    ...
    ap_ST_fsm_state5_blk_assign_proc : process(grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done)
    begin
        if ((grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_done = ap_const_logic_0)) then 
    ...
    ap_int_blocking_cur_n <= (rows_blk_n and ldata1_blk_n and cols_bound_per_npc_blk_n);
    ...
    ap_sub_ext_blocking_0_assign_proc : process(grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ext_blocking_n)
    begin
        if ((grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_ext_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_int_blocking_0_assign_proc : process(grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_int_blocking_n)
    begin
        if ((grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_int_blocking_n = ap_const_logic_0)) then 
    ...
    ap_sub_str_blocking_0_assign_proc : process(grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_str_blocking_n)
    begin
        if ((grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_str_blocking_n = ap_const_logic_0)) then 
    ...
    grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start <= grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ap_start_reg;
    ...
    icmp_ln1023_fu_119_p2 <= "1" when (grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_filled_V_1_out = ap_const_lv9_0) else "0";
    ...
    ldata1_din_assign_proc : process(ldata1_full_n, ap_CS_fsm_state6, icmp_ln1023_fu_119_p2, grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata1_din, grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_V_3_out, ap_CS_fsm_state5)
    begin
        if ((not(((icmp_ln1023_fu_119_p2 = ap_const_lv1_0) and (ldata1_full_n = ap_const_logic_0))) and (icmp_ln1023_fu_119_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
            ldata1_din <= grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_localbuffer_V_3_out;
    ...
    ldata1_write_assign_proc : process(ldata1_full_n, ap_CS_fsm_state6, icmp_ln1023_fu_119_p2, grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_ldata1_write, ap_CS_fsm_state5)
    begin
        if ((not(((icmp_ln1023_fu_119_p2 = ap_const_lv1_0) and (ldata1_full_n = ap_const_logic_0))) and (icmp_ln1023_fu_119_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
    ...
    out_mat_data2_read_assign_proc : process(grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79_out_mat_data2_read, ap_CS_fsm_state5)
    begin
