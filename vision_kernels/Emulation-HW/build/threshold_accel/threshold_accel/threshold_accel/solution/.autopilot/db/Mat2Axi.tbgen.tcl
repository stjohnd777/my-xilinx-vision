...
set portNum 65
set portList { 
	{ out_mat_data2_dout sc_in sc_lv 8 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.addrbound_U0", "Parent" : "0", "Child" : ["3"],
		...
		"Port" : [
			...
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.addrbound_U0.mul_mul_16ns_16ns_32_3_1_U79", "Parent" : "2"},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0", "Parent" : "0", "Child" : ["6", "7", "8", "12", "13", "14"],
		...
		"OutputProcess" : [
			{"ID" : "8", "Name" : "MatStream2AxiStream_1_U0"}],
		"Port" : [
			{"Name" : "out_mat_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "MatStream2AxiStream_1_U0", "Port" : "out_mat_data2"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["15"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "MatStream2AxiStream_1_U0", "Port" : "ldata1"}]},
			{"Name" : "rows", "Type" : "None", "Direction" : "I"},
			{"Name" : "cols", "Type" : "None", "Direction" : "I"}]},
	...
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_1_U0", "Parent" : "5", "Child" : ["9", "11"],
		...
		"Port" : [
			{"Name" : "out_mat_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "out_mat_data2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["15"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ldata1_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "9", "SubInstance" : "grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "ldata1", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_1_U0.grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Parent" : "8", "Child" : ["10"],
	...
	{"ID" : "10", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_1_U0.grp_MatStream2AxiStream_1_Pipeline_MMIterOutRow_MMIterOutCol_fu_79.flow_control_loop_pipe_sequential_init_U", "Parent" : "9"},
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.Mat2AxiStream_U0.MatStream2AxiStream_1_U0.mul_mul_16ns_16ns_32_4_1_U98", "Parent" : "8"},
	...
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AxiStream2Axi_U0", "Parent" : "0", "Child" : ["16"],
		...
		"Port" : [
			{"Name" : "ldata1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["5","8"], "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "16", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73", "Port" : "ldata1", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem2", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem2_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem2_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "16", "SubInstance" : "grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73", "Port" : "gmem2", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
	...
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.AxiStream2Axi_U0.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73", "Parent" : "15", "Child" : ["17"],
	...
	{"ID" : "17", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.AxiStream2Axi_U0.grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73.flow_control_loop_pipe_sequential_init_U", "Parent" : "16"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "79", "Max" : "2073609"}
	, {"Name" : "Interval", "Min" : "76", "Max" : "2073609"}
]}
...
set Spec2ImplPortList { 
	out_mat_data2 { ap_fifo {  { out_mat_data2_dout fifo_port_we 0 8 }  { out_mat_data2_empty_n fifo_status 0 1 }  { out_mat_data2_read fifo_data 1 1 } } }
