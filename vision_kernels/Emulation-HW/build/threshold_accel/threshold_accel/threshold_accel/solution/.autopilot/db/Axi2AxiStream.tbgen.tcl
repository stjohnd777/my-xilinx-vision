...
set C_modelArgList {
	...
	{ din int 64 regular  }
	{ ldata int 256 regular {fifo 1 volatile }  }
	{ rows int 32 regular  }
	{ cols int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_inp","offset": { "type": "dynamic","port_name": "img_inp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "ldata", "interface" : "fifo", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ ldata_din sc_out sc_lv 256 signal 2 } 
	{ ldata_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ ldata_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ rows_c_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ rows_c_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ rows_c_full_n sc_in sc_logic 1 signal 5 } 
	{ rows_c_write sc_out sc_logic 1 signal 5 } 
	{ cols_c_din sc_out sc_lv 32 signal 6 } 
	{ cols_c_num_data_valid sc_in sc_lv 2 signal 6 } 
	{ cols_c_fifo_cap sc_in sc_lv 2 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ldata_din", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "ldata", "role": "din" }} , 
 	{ "name": "ldata_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "ldata", "role": "num_data_valid" }} , 
 	{ "name": "ldata_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "ldata", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Axi2AxiStream_Pipeline_VITIS_LOOP_1022_1_fu_126", "Port" : "gmem1", "Inst_start_state" : "74", "Inst_end_state" : "75"}]},
			...
			{"Name" : "ldata", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0","0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_Axi2AxiStream_Pipeline_VITIS_LOOP_1022_1_fu_126", "Port" : "ldata", "Inst_start_state" : "74", "Inst_end_state" : "75"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_Axi2AxiStream_Pipeline_VITIS_LOOP_1022_1_fu_126", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_Axi2AxiStream_Pipeline_VITIS_LOOP_1022_1_fu_126.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_16ns_16ns_32_3_1_U13", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "78", "Max" : "137"}
	, {"Name" : "Interval", "Min" : "78", "Max" : "137"}
]}
...
set Spec2ImplPortList { 
	...
	ldata { ap_fifo {  { ldata_din fifo_port_we 1 256 }  { ldata_num_data_valid fifo_status_num_data_valid 0 2 }  { ldata_fifo_cap fifo_update 0 2 }  { ldata_full_n fifo_status 0 1 }  { ldata_write fifo_data 1 1 } } }
