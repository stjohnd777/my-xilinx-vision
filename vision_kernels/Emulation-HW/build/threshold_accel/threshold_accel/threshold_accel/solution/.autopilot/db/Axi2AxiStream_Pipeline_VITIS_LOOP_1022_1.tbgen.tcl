...
set C_modelArgList {
	...
	{ cols_addrbound_V int 17 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "img_inp","offset": { "type": "dynamic","port_name": "img_inp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "cols_addrbound_V", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ cols_addrbound_V sc_in sc_lv 17 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cols_addrbound_V", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "cols_addrbound_V", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "63"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "63"}
]}
...
set Spec2ImplPortList { 
	...
	cols_addrbound_V { ap_none {  { cols_addrbound_V in_data 0 17 } } }
