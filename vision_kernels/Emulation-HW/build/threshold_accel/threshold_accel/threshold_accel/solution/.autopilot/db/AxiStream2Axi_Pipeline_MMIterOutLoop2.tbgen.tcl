...
set C_modelArgMapList {[ 
	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "img_out","offset": { "type": "dynamic","port_name": "img_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln1380", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem2_WDATA sc_out sc_lv 256 signal 0 } 
	{ m_axi_gmem2_WSTRB sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_gmem2_RDATA sc_in sc_lv 256 signal 0 } 
	...
	{ sext_ln1380 sc_in sc_lv 59 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1380", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln1380", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1380 { ap_none {  { sext_ln1380 in_data 0 59 } } }
