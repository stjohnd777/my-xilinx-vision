...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln1380 \
    op interface \
    ports { sext_ln1380 { I 59 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ldata1 \
    op interface \
    ports { ldata1_dout { I 256 vector } ldata1_num_data_valid { I 2 vector } ldata1_fifo_cap { I 2 vector } ldata1_empty_n { I 1 bit } ldata1_read { O 1 bit } } \
} "
}
...
set InstName threshold_accel_flow_control_loop_pipe_sequential_init_U
set CompName threshold_accel_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix threshold_accel_ \
}"
} else {
