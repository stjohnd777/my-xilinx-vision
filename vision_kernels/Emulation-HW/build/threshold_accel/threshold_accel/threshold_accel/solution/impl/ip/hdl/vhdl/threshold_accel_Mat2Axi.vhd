...
entity threshold_accel_Mat2Axi is
port (
...
architecture behav of threshold_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc4_U0_ap_ext_blocking_n : STD_LOGIC;
    signal entry_proc4_U0_ap_str_blocking_n : STD_LOGIC;
    signal entry_proc4_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    signal addrbound_U0_p_channel : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal Mat2Axi_Block_entry24_proc_U0_ap_return : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal p_channel_dout : STD_LOGIC_VECTOR (16 downto 0);
    ...
    component threshold_accel_entry_proc4 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        p_channel : OUT STD_LOGIC_VECTOR (16 downto 0);
        rows : IN STD_LOGIC_VECTOR (15 downto 0);
    ...
    component threshold_accel_Mat2Axi_Block_entry24_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_Mat2AxiStream IS
    port (
        out_mat_data2_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        out_mat_data2_empty_n : IN STD_LOGIC;
        out_mat_data2_read : OUT STD_LOGIC;
    ...
    component threshold_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component threshold_accel_fifo_w17_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component threshold_accel_fifo_w256_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc4_U0 : component threshold_accel_entry_proc4
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_ext_blocking_n => entry_proc4_U0_ap_ext_blocking_n,
        ap_str_blocking_n => entry_proc4_U0_ap_str_blocking_n,
        ap_int_blocking_n => entry_proc4_U0_ap_int_blocking_n);

    addrbound_U0 : component threshold_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_entry24_proc_U0 : component threshold_accel_Mat2Axi_Block_entry24_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component threshold_accel_Mat2AxiStream
    port map (
    ...
    AxiStream2Axi_U0 : component threshold_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component threshold_accel_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    p_channel_U : component threshold_accel_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component threshold_accel_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component threshold_accel_fifo_w256_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (entry_proc4_U0_ap_ext_blocking_n and addrbound_U0_ap_ext_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_ext_blocking_n and Mat2AxiStream_U0_ap_ext_blocking_n and AxiStream2Axi_U0_ap_ext_blocking_n);
    ...
    ap_int_blocking_sub_n <= (entry_proc4_U0_ap_int_blocking_n and addrbound_U0_ap_int_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_int_blocking_n and Mat2AxiStream_U0_ap_int_blocking_n and AxiStream2Axi_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (entry_proc4_U0_ap_str_blocking_n and addrbound_U0_ap_str_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_str_blocking_n and Mat2AxiStream_U0_ap_str_blocking_n and AxiStream2Axi_U0_ap_str_blocking_n);
