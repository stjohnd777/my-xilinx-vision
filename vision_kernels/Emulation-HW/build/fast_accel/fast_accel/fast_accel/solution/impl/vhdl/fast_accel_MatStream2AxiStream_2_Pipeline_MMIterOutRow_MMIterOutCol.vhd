...
entity fast_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fast_accel_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1027_5_reg_454 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op53_read_state3 : BOOLEAN;
    signal icmp_ln1027_6_reg_463 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln1027_5_fu_247_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln930_1_fu_252_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln930_1_reg_458 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln1027_6_fu_262_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal r_V_1_fu_368_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln1027_4_fu_213_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ret_V_16_fu_321_p2 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_124)) then
                if (((icmp_ln1027_fu_199_p2 = ap_const_lv1_0) and (icmp_ln1027_5_fu_247_p2 = ap_const_lv1_0))) then 
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    localbuffer_V_fu_82 <= r_V_1_fu_368_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1027_fu_199_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln1027_5_reg_454 <= icmp_ln1027_5_fu_247_p2;
                icmp_ln1027_6_reg_463 <= icmp_ln1027_6_fu_262_p2;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter2, imgOutput_data2_empty_n, ap_predicate_op53_read_state3, ldata1_full_n, ap_predicate_op60_write_state3)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (((ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ldata1_full_n = ap_const_logic_0)) or ((ap_predicate_op53_read_state3 = ap_const_boolean_1) and (imgOutput_data2_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter2, imgOutput_data2_empty_n, ap_predicate_op53_read_state3, ldata1_full_n, ap_predicate_op60_write_state3)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (((ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ldata1_full_n = ap_const_logic_0)) or ((ap_predicate_op53_read_state3 = ap_const_boolean_1) and (imgOutput_data2_empty_n = ap_const_logic_0))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter2, imgOutput_data2_empty_n, ap_predicate_op53_read_state3, ldata1_full_n, ap_predicate_op60_write_state3)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (((ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ldata1_full_n = ap_const_logic_0)) or ((ap_predicate_op53_read_state3 = ap_const_boolean_1) and (imgOutput_data2_empty_n = ap_const_logic_0))));
    end process;

        ap_block_state1_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state2_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state3_pp0_stage0_iter2_assign_proc : process(imgOutput_data2_empty_n, ap_predicate_op53_read_state3, ldata1_full_n, ap_predicate_op60_write_state3)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (((ap_predicate_op60_write_state3 = ap_const_boolean_1) and (ldata1_full_n = ap_const_logic_0)) or ((ap_predicate_op53_read_state3 = ap_const_boolean_1) and (imgOutput_data2_empty_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_364_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln1027_reg_450, icmp_ln1027_6_reg_463)
    begin
                ap_condition_364 <= ((icmp_ln1027_6_reg_463 = ap_const_lv1_0) and (icmp_ln1027_reg_450 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1));
    end process;


    ap_condition_367_assign_proc : process(ap_enable_reg_pp0_iter2, icmp_ln1027_reg_450, icmp_ln1027_6_reg_463)
    begin
                ap_condition_367 <= ((icmp_ln1027_6_reg_463 = ap_const_lv1_1) and (icmp_ln1027_reg_450 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1));
    end process;
    ...
    ap_int_blocking_cur_n <= (ldata1_blk_n and imgOutput_data2_blk_n);
    ap_int_blocking_n <= (ap_int_blocking_cur_n and ap_const_logic_1);
    ap_loop_exit_ready <= ap_condition_exit_pp0_iter1_stage0;

    ap_phi_mux_conv3_i12_i_i933_pn_phi_fu_154_p4_assign_proc : process(icmp_ln1027_fu_199_p2, icmp_ln1027_6_fu_262_p2, xor_ln186_fu_268_p2, ap_phi_reg_pp0_iter1_conv3_i12_i_i933_pn_reg_151, xf_bits_per_clock_fu_235_p3)
    begin
        if ((icmp_ln1027_fu_199_p2 = ap_const_lv1_0)) then
            if ((icmp_ln1027_6_fu_262_p2 = ap_const_lv1_1)) then 
                ap_phi_mux_conv3_i12_i_i933_pn_phi_fu_154_p4 <= xf_bits_per_clock_fu_235_p3;
            elsif ((icmp_ln1027_6_fu_262_p2 = ap_const_lv1_0)) then 
    ...
    ap_phi_mux_val_V_1_phi_fu_164_p4_assign_proc : process(imgOutput_data2_dout, icmp_ln1027_reg_450, icmp_ln1027_5_reg_454, ap_phi_reg_pp0_iter2_val_V_1_reg_160)
    begin
        if (((icmp_ln1027_5_reg_454 = ap_const_lv1_1) and (icmp_ln1027_reg_450 = ap_const_lv1_0))) then 
            ap_phi_mux_val_V_1_phi_fu_164_p4 <= imgOutput_data2_dout;
        else 
    ...
    ap_predicate_op53_read_state3_assign_proc : process(icmp_ln1027_reg_450, icmp_ln1027_5_reg_454)
    begin
                ap_predicate_op53_read_state3 <= ((icmp_ln1027_5_reg_454 = ap_const_lv1_1) and (icmp_ln1027_reg_450 = ap_const_lv1_0));
    end process;


    ap_predicate_op60_write_state3_assign_proc : process(icmp_ln1027_reg_450, icmp_ln1027_6_reg_463)
    begin
                ap_predicate_op60_write_state3 <= ((icmp_ln1027_6_reg_463 = ap_const_lv1_0) and (icmp_ln1027_reg_450 = ap_const_lv1_0));
    end process;
    ...
    icmp_ln1027_4_fu_213_p2 <= "1" when (j_V_fu_86 = strideBased_cols_bound_per_npc_V) else "0";
    icmp_ln1027_5_fu_247_p2 <= "1" when (signed(zext_ln1027_fu_226_p1) < signed(cols_bound_per_npc_load)) else "0";
    icmp_ln1027_6_fu_262_p2 <= "1" when (signed(sub_ln1325_fu_256_p2) > signed(zext_ln930_1_fu_252_p1)) else "0";
    icmp_ln1027_fu_199_p2 <= "1" when (indvar_flatten_fu_90 = bound) else "0";

    imgOutput_data2_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, imgOutput_data2_empty_n, ap_predicate_op53_read_state3, ap_block_pp0_stage0)
    begin
    ...
    imgOutput_data2_read_assign_proc : process(ap_enable_reg_pp0_iter2, ap_predicate_op53_read_state3, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op53_read_state3 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            imgOutput_data2_read <= ap_const_logic_1;
        else 
    ...
    p_Result_s_fu_330_p3 <= ret_V_16_fu_321_p2(4 downto 4);
    r_V_1_fu_368_p3 <= 
        shl_ln930_1_fu_352_p2 when (p_Result_s_fu_330_p3(0) = '1') else 
        lshr_ln948_fu_362_p2;
    ret_V_16_fu_321_p2 <= std_logic_vector(unsigned(ap_const_lv5_8) - unsigned(zext_ln930_1_reg_458));
    ret_V_fu_314_p2 <= (shl_ln930_fu_308_p2 or localbuffer_V_fu_82);
    select_ln1295_fu_218_p3 <= 
        ap_const_lv16_0 when (icmp_ln1027_4_fu_213_p2(0) = '1') else 
        j_V_fu_86;
        sext_ln455_fu_338_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ret_V_16_fu_321_p2),32));
    ...
    trunc_ln1496_fu_326_p1 <= ret_V_16_fu_321_p2(3 - 1 downto 0);
