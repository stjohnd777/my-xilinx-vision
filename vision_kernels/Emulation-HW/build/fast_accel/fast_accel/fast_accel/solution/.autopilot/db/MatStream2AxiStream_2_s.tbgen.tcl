...
set portList { 
	...
	{ imgOutput_data2_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ imgOutput_data2_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3"],
		...
		"Port" : [
			{"Name" : "imgOutput_data2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_MatStream2AxiStream_2_Pipeline_MMIterOutRow_MMIterOutCol_fu_79", "Port" : "imgOutput_data2", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_16ns_16ns_32_4_1_U225", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8", "Max" : "8294407"}
	, {"Name" : "Interval", "Min" : "8", "Max" : "8294407"}
]}
