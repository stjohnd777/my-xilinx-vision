...
set portList { 
	...
	{ threshold_c_din sc_out sc_lv 8 signal 1 } 
	{ threshold_c_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ threshold_c_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ threshold_c_full_n sc_in sc_logic 1 signal 1 } 
	{ threshold_c_write sc_out sc_logic 1 signal 1 } 
	{ img_out sc_in sc_lv 64 signal 2 } 
	{ img_out_c_din sc_out sc_lv 64 signal 3 } 
	{ img_out_c_num_data_valid sc_in sc_lv 4 signal 3 } 
	{ img_out_c_fifo_cap sc_in sc_lv 4 signal 3 } 
	{ img_out_c_full_n sc_in sc_logic 1 signal 3 } 
	{ img_out_c_write sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "threshold_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "threshold_c", "role": "din" }} , 
 	{ "name": "threshold_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "threshold_c", "role": "num_data_valid" }} , 
 	{ "name": "threshold_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "threshold_c", "role": "fifo_cap" }} , 
 	{ "name": "threshold_c_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "threshold_c", "role": "full_n" }} , 
 	{ "name": "threshold_c_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "threshold_c", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "threshold_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	threshold_c { ap_fifo {  { threshold_c_din fifo_port_we 1 8 }  { threshold_c_num_data_valid fifo_status_num_data_valid 0 3 }  { threshold_c_fifo_cap fifo_update 0 3 }  { threshold_c_full_n fifo_status 0 1 }  { threshold_c_write fifo_data 1 1 } } }
