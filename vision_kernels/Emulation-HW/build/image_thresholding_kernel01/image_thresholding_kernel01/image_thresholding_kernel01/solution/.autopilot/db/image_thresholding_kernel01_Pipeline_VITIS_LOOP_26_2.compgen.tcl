...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outBRAM \
    op interface \
    ports { outBRAM_address0 { O 21 vector } outBRAM_ce0 { O 1 bit } outBRAM_we0 { O 1 bit } outBRAM_d0 { O 8 vector } outBRAM_address1 { O 21 vector } outBRAM_ce1 { O 1 bit } outBRAM_we1 { O 1 bit } outBRAM_d1 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'outBRAM'"
}
}
...
set InstName image_thresholding_kernel01_flow_control_loop_pipe_sequential_init_U
set CompName image_thresholding_kernel01_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix image_thresholding_kernel01_ \
}"
} else {
