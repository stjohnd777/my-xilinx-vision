set moduleName image_thresholding_kernel01_Pipeline_VITIS_LOOP_33_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {image_thresholding_kernel01_Pipeline_VITIS_LOOP_33_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 1}  }
	{ sext_ln33 int 63 regular  }
	{ outBRAM int 8 regular {array 2073600 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_image","offset": { "type": "dynamic","port_name": "output_image","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln33", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
 	{ "Name" : "outBRAM", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln33 sc_in sc_lv 63 signal 1 } 
	{ outBRAM_address0 sc_out sc_lv 21 signal 2 } 
	{ outBRAM_ce0 sc_out sc_logic 1 signal 2 } 
	{ outBRAM_q0 sc_in sc_lv 8 signal 2 } 
	{ outBRAM_address1 sc_out sc_lv 21 signal 2 } 
	{ outBRAM_ce1 sc_out sc_logic 1 signal 2 } 
	{ outBRAM_q1 sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln33", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln33", "role": "default" }} , 
 	...
 	{ "name": "outBRAM_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outBRAM", "role": "q0" }} , 
 	...
 	{ "name": "outBRAM_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outBRAM", "role": "q1" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln33 { ap_none {  { sext_ln33 in_data 0 63 } } }
	outBRAM { ap_memory {  { outBRAM_address0 mem_address 1 21 }  { outBRAM_ce0 mem_ce 1 1 }  { outBRAM_q0 mem_dout 0 8 }  { outBRAM_address1 MemPortADDR2 1 21 }  { outBRAM_ce1 MemPortCE2 1 1 }  { outBRAM_q1 MemPortDOUT2 0 8 } } }
}
