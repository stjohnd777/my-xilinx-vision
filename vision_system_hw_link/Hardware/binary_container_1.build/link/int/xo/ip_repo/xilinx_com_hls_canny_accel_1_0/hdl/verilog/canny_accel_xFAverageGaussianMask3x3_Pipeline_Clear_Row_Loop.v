...
module canny_accel_xFAverageGaussianMask3x3_Pipeline_Clear_Row_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [12:0] col_V_12_fu_120_p2;
wire    ap_loop_init;
reg   [12:0] ap_sig_allocacmp_col_V_11;
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_col_V_11 = 13'd0;
    end else begin
...
assign buf_V_5_address1 = zext_ln541_reg_146;

assign buf_V_5_d1 = in_mat_data1_dout;

assign buf_V_address1 = zext_ln541_fu_126_p1;

assign buf_V_d1 = 8'd0;

assign col_V_12_fu_120_p2 = (ap_sig_allocacmp_col_V_11 + 13'd1);

assign icmp_ln1027_fu_114_p2 = ((zext_ln1027_fu_110_p1 < img_width) ? 1'b1 : 1'b0);

assign zext_ln1027_fu_110_p1 = ap_sig_allocacmp_col_V_11;

assign zext_ln541_fu_126_p1 = ap_sig_allocacmp_col_V_11;

always @ (posedge ap_clk) begin
    zext_ln541_reg_146[63:13] <= 51'b000000000000000000000000000000000000000000000000000;
end

endmodule //canny_accel_xFAverageGaussianMask3x3_Pipeline_Clear_Row_Loop
