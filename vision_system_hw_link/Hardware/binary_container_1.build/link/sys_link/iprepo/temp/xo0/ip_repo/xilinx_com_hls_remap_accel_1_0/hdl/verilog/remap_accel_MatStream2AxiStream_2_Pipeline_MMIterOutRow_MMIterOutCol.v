...
always @ (*) begin
    ap_condition_351 = ((icmp_ln1027_3_reg_463 == 1'd0) & (icmp_ln1027_reg_450 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_condition_354 = ((icmp_ln1027_3_reg_463 == 1'd1) & (icmp_ln1027_reg_450 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
