...
always @ (*) begin
    ap_condition_357 = ((icmp_ln1027_4_reg_449 == 1'd0) & (icmp_ln1027_reg_421_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_condition_360 = ((icmp_ln1027_4_reg_449 == 1'd1) & (icmp_ln1027_reg_421_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
