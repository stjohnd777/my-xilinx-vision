...
module gaussian_filter_accel_xfGaussianFilter3x3_Pipeline_Clear_Row_Loop (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign col_V_2_fu_120_p2 = (ap_sig_allocacmp_col_V_1 + 13'd1);

assign icmp_ln1027_fu_114_p2 = ((zext_ln1027_fu_110_p1 < img_width) ? 1'b1 : 1'b0);

assign zext_ln1027_fu_110_p1 = ap_sig_allocacmp_col_V_1;

assign zext_ln541_fu_126_p1 = ap_sig_allocacmp_col_V_1;

always @ (posedge ap_clk) begin
    zext_ln541_reg_146[63:13] <= 51'b000000000000000000000000000000000000000000000000000;
end

endmodule //gaussian_filter_accel_xfGaussianFilter3x3_Pipeline_Clear_Row_Loop
