...
module fast_accel_xFfastnms_0_2160_3840_0_1_2_2_1_3841_3_9_4_Pipeline_VITIS_LOOP_876_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((row_ind_V_5_load_fu_74_p1 == 2'd1) & (icmp_ln1027_fu_77_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        row_ind_V_1_fu_40[1 : 0] <= zext_ln214_fu_89_p1[1 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((~(row_ind_V_5_load_fu_74_p1 == 2'd1) & ~(row_ind_V_5_load_fu_74_p1 == 2'd0) & (icmp_ln1027_fu_77_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        row_ind_V_2_fu_44[1 : 0] <= zext_ln214_fu_89_p1[1 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((row_ind_V_5_load_fu_74_p1 == 2'd0) & (icmp_ln1027_fu_77_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign icmp_ln1027_fu_77_p2 = ((ap_sig_allocacmp_row_ind_V_5 == 2'd3) ? 1'b1 : 1'b0);
...
endmodule //fast_accel_xFfastnms_0_2160_3840_0_1_2_2_1_3841_3_9_4_Pipeline_VITIS_LOOP_876_1
