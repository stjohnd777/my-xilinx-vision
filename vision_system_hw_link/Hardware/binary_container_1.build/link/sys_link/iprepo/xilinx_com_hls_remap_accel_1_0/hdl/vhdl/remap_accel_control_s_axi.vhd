...
entity remap_accel_control_s_axi is
generic (
...
port (
    ...
    map_x                 :out  STD_LOGIC_VECTOR(63 downto 0);
    map_y                 :out  STD_LOGIC_VECTOR(63 downto 0);
...
end entity remap_accel_control_s_axi;
...
-- 0x18 : reserved
-- 0x1c : Data signal of map_x
--        bit 31~0 - map_x[31:0] (Read/Write)
-- 0x20 : Data signal of map_x
--        bit 31~0 - map_x[63:32] (Read/Write)
-- 0x24 : reserved
-- 0x28 : Data signal of map_y
--        bit 31~0 - map_y[31:0] (Read/Write)
-- 0x2c : Data signal of map_y
--        bit 31~0 - map_y[63:32] (Read/Write)
-- 0x30 : reserved
-- 0x34 : Data signal of img_out
--        bit 31~0 - img_out[31:0] (Read/Write)
-- 0x38 : Data signal of img_out
...
architecture behave of remap_accel_control_s_axi is
    ...
    constant ADDR_MAP_X_DATA_0   : INTEGER := 16#1c#;
    constant ADDR_MAP_X_DATA_1   : INTEGER := 16#20#;
    constant ADDR_MAP_X_CTRL     : INTEGER := 16#24#;
    constant ADDR_MAP_Y_DATA_0   : INTEGER := 16#28#;
    constant ADDR_MAP_Y_DATA_1   : INTEGER := 16#2c#;
    constant ADDR_MAP_Y_CTRL     : INTEGER := 16#30#;
    constant ADDR_IMG_OUT_DATA_0 : INTEGER := 16#34#;
    constant ADDR_IMG_OUT_DATA_1 : INTEGER := 16#38#;
    constant ADDR_IMG_OUT_CTRL   : INTEGER := 16#3c#;
    ...
    signal int_map_x           : UNSIGNED(63 downto 0) := (others => '0');
    signal int_map_y           : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_MAP_X_DATA_0 =>
                        rdata_data <= RESIZE(int_map_x(31 downto 0), 32);
                    when ADDR_MAP_X_DATA_1 =>
                        rdata_data <= RESIZE(int_map_x(63 downto 32), 32);
                    when ADDR_MAP_Y_DATA_0 =>
                        rdata_data <= RESIZE(int_map_y(31 downto 0), 32);
                    when ADDR_MAP_Y_DATA_1 =>
                        rdata_data <= RESIZE(int_map_y(63 downto 32), 32);
...
-- ----------------------- Register logic ----------------
    ...
    map_x                <= STD_LOGIC_VECTOR(int_map_x);
    map_y                <= STD_LOGIC_VECTOR(int_map_y);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAP_X_DATA_0) then
                    int_map_x(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_map_x(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAP_X_DATA_1) then
                    int_map_x(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_map_x(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAP_Y_DATA_0) then
                    int_map_y(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_map_y(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MAP_Y_DATA_1) then
                    int_map_y(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_map_y(63 downto 32));
                end if;
            end if;
        end if;
    end process;
