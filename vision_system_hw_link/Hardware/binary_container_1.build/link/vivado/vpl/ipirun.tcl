...
set hw_platform_info [dict create \
  ...
  hw_platform_file             "/tools/Xilinx/Vitis/2022.2/base_platforms/xilinx_zcu102_base_202220_1/hw/hw.xsa" \
...
set config_info [dict create \
  ...
  kernels                  "fast_accel threshold_accel canny_accel image_thresholding_kernel01 image_thresholding_kernel00 sobel_accel remap_accel gaussian_filter_accel" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
  num_jobs_synth            8 \
  ...
  no_ip_cache               false \
  remote_ip_cache          "/home/overman/dev/workspaces/vision/vision_system_hw_link/Hardware/.ipcache" \
  user_board_repo           {} \
  user_bconn                {} \
