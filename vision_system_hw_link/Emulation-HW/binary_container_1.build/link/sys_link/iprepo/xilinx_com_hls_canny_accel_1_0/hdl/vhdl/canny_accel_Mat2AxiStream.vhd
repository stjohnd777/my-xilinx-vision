...
attribute shreg_extract : string;
    ...
    signal cols_npc_aligned_U0_ap_start : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_done : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_continue : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_idle : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_ready : STD_LOGIC;
    signal cols_npc_aligned_U0_cols_c_din : STD_LOGIC_VECTOR (10 downto 0);
    signal cols_npc_aligned_U0_cols_c_write : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_return_0 : STD_LOGIC_VECTOR (6 downto 0);
    signal cols_npc_aligned_U0_ap_return_1 : STD_LOGIC_VECTOR (6 downto 0);
    signal cols_npc_aligned_U0_ap_ext_blocking_n : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_str_blocking_n : STD_LOGIC;
    signal cols_npc_aligned_U0_ap_int_blocking_n : STD_LOGIC;
    signal ap_channel_done_cols_bound_per_npc_dup_1 : STD_LOGIC;
    signal cols_bound_per_npc_dup_1_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_cols_bound_per_npc_dup_1 : STD_LOGIC := '0';
    signal ap_sync_channel_write_cols_bound_per_npc_dup_1 : STD_LOGIC;
    signal ap_channel_done_cols_bound_per_npc_dup : STD_LOGIC;
    signal cols_bound_per_npc_dup_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_cols_bound_per_npc_dup : STD_LOGIC := '0';
    signal ap_sync_channel_write_cols_bound_per_npc_dup : STD_LOGIC;
    ...
    signal MatStream2AxiStream_2_U0_dst_mat_data2_read : STD_LOGIC;
    ...
    signal cols_bound_per_npc_dup_dout : STD_LOGIC_VECTOR (6 downto 0);
    signal cols_bound_per_npc_dup_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal cols_bound_per_npc_dup_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal cols_bound_per_npc_dup_empty_n : STD_LOGIC;
    signal cols_bound_per_npc_dup_1_dout : STD_LOGIC_VECTOR (6 downto 0);
    signal cols_bound_per_npc_dup_1_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal cols_bound_per_npc_dup_1_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal cols_bound_per_npc_dup_1_empty_n : STD_LOGIC;
    signal last_blk_width_channel_dout : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal ap_sync_reg_cols_npc_aligned_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_cols_npc_aligned_U0_ap_ready : STD_LOGIC;
    ...
    component canny_accel_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component canny_accel_cols_npc_aligned IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w16_d4_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component canny_accel_fifo_w7_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component canny_accel_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    cols_npc_aligned_U0 : component canny_accel_cols_npc_aligned
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_ext_blocking_n => cols_npc_aligned_U0_ap_ext_blocking_n,
        ap_str_blocking_n => cols_npc_aligned_U0_ap_str_blocking_n,
        ap_int_blocking_n => cols_npc_aligned_U0_ap_int_blocking_n);
    ...
    rows_c_U : component canny_accel_fifo_w16_d4_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    cols_c_U : component canny_accel_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_bound_per_npc_dup_U : component canny_accel_fifo_w7_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cols_bound_per_npc_dup_1_U : component canny_accel_fifo_w7_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    last_blk_width_channel_U : component canny_accel_fifo_w7_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_channel_write_cols_bound_per_npc_dup_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_cols_bound_per_npc_dup <= ap_const_logic_0;
            else
                if (((cols_npc_aligned_U0_ap_done and cols_npc_aligned_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_cols_bound_per_npc_dup <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_channel_write_cols_bound_per_npc_dup_1_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_cols_bound_per_npc_dup_1 <= ap_const_logic_0;
            else
                if (((cols_npc_aligned_U0_ap_done and cols_npc_aligned_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_cols_bound_per_npc_dup_1 <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_cols_npc_aligned_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_cols_npc_aligned_U0_ap_ready <= ap_const_logic_0;
            else
    ...
    MatStream2AxiStream_2_U0_ap_start <= (last_blk_width_channel_empty_n and cols_bound_per_npc_dup_empty_n);
    ap_channel_done_cols_bound_per_npc_dup <= ((ap_sync_reg_channel_write_cols_bound_per_npc_dup xor ap_const_logic_1) and cols_npc_aligned_U0_ap_done);
    ap_channel_done_cols_bound_per_npc_dup_1 <= ((ap_sync_reg_channel_write_cols_bound_per_npc_dup_1 xor ap_const_logic_1) and cols_npc_aligned_U0_ap_done);
    ap_done <= MatStream2AxiStream_2_U0_ap_done;
    ap_ext_blocking_cur_n <= ap_const_logic_1;
    ap_ext_blocking_n <= (ap_ext_blocking_sub_n and ap_ext_blocking_cur_n);
    ap_ext_blocking_sub_n <= (last_blk_pxl_width_U0_ap_ext_blocking_n and entry_proc_U0_ap_ext_blocking_n and cols_npc_aligned_U0_ap_ext_blocking_n and MatStream2AxiStream_2_U0_ap_ext_blocking_n);
    ap_idle <= (last_blk_pxl_width_U0_ap_idle and (last_blk_width_channel_empty_n xor ap_const_logic_1) and (cols_bound_per_npc_dup_1_empty_n xor ap_const_logic_1) and (cols_bound_per_npc_dup_empty_n xor ap_const_logic_1) and entry_proc_U0_ap_idle and cols_npc_aligned_U0_ap_idle and MatStream2AxiStream_2_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (last_blk_pxl_width_U0_ap_int_blocking_n and entry_proc_U0_ap_int_blocking_n and cols_npc_aligned_U0_ap_int_blocking_n and MatStream2AxiStream_2_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (last_blk_pxl_width_U0_ap_str_blocking_n and entry_proc_U0_ap_str_blocking_n and cols_npc_aligned_U0_ap_str_blocking_n and MatStream2AxiStream_2_U0_ap_str_blocking_n);
    ap_sync_channel_write_cols_bound_per_npc_dup <= ((cols_bound_per_npc_dup_full_n and ap_channel_done_cols_bound_per_npc_dup) or ap_sync_reg_channel_write_cols_bound_per_npc_dup);
    ap_sync_channel_write_cols_bound_per_npc_dup_1 <= ((cols_bound_per_npc_dup_1_full_n and ap_channel_done_cols_bound_per_npc_dup_1) or ap_sync_reg_channel_write_cols_bound_per_npc_dup_1);
    ap_sync_cols_npc_aligned_U0_ap_ready <= (cols_npc_aligned_U0_ap_ready or ap_sync_reg_cols_npc_aligned_U0_ap_ready);
    ap_sync_entry_proc_U0_ap_ready <= (entry_proc_U0_ap_ready or ap_sync_reg_entry_proc_U0_ap_ready);
    ap_sync_ready <= (ap_sync_entry_proc_U0_ap_ready and ap_sync_cols_npc_aligned_U0_ap_ready);
    cols_npc_aligned_U0_ap_continue <= (ap_sync_channel_write_cols_bound_per_npc_dup_1 and ap_sync_channel_write_cols_bound_per_npc_dup);
    cols_npc_aligned_U0_ap_start <= ((ap_sync_reg_cols_npc_aligned_U0_ap_ready xor ap_const_logic_1) and ap_start);
    dst_mat_data2_read <= MatStream2AxiStream_2_U0_dst_mat_data2_read;
    entry_proc_U0_ap_continue <= ap_const_logic_1;
    entry_proc_U0_ap_start <= ((ap_sync_reg_entry_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    last_blk_pxl_width_U0_ap_continue <= last_blk_width_channel_full_n;
    last_blk_pxl_width_U0_ap_start <= cols_bound_per_npc_dup_1_empty_n;
    ldata1_din <= MatStream2AxiStream_2_U0_ldata1_din;
    ldata1_write <= MatStream2AxiStream_2_U0_ldata1_write;
end behav;
