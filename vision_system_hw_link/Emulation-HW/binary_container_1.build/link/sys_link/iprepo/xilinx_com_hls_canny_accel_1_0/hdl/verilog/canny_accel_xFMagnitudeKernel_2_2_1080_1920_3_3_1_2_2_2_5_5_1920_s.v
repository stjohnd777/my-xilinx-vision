...
wire    grp_xFMagnitudeKernel_Pipeline_colLoop_fu_56_ap_ext_blocking_n;
wire    grp_xFMagnitudeKernel_Pipeline_colLoop_fu_56_ap_str_blocking_n;
wire    grp_xFMagnitudeKernel_Pipeline_colLoop_fu_56_ap_int_blocking_n;
...
always @ (*) begin
    if ((grp_xFMagnitudeKernel_Pipeline_colLoop_fu_56_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFMagnitudeKernel_Pipeline_colLoop_fu_56_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_xFMagnitudeKernel_Pipeline_colLoop_fu_56_ap_str_blocking_n == 1'b0)) begin
