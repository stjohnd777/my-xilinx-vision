...
localparam
    ...
    ADDR_THRESH_DATA_0  = 7'h28,
    ADDR_THRESH_CTRL    = 7'h2c,
    ADDR_MAXVAL_DATA_0  = 7'h30,
    ADDR_MAXVAL_CTRL    = 7'h34,
    ADDR_ROWS_DATA_0    = 7'h38,
    ADDR_ROWS_CTRL      = 7'h3c,
    ADDR_COLS_DATA_0    = 7'h40,
    ADDR_COLS_CTRL      = 7'h44,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    WRRESET             = 2'd3,
