...
wire    entry_proc15_U0_rows_read;
wire   [31:0] entry_proc15_U0_rows_c_din;
wire    entry_proc15_U0_rows_c_write;
wire    entry_proc15_U0_cols_read;
wire   [31:0] entry_proc15_U0_cols_c_din;
wire    entry_proc15_U0_cols_c_write;
wire    entry_proc15_U0_ap_ext_blocking_n;
wire    entry_proc15_U0_ap_str_blocking_n;
wire    entry_proc15_U0_ap_int_blocking_n;
...
wire   [7:0] AxiStream2MatStream_2_U0_in_mat_data1_din;
wire    AxiStream2MatStream_2_U0_in_mat_data1_write;
...
canny_accel_entry_proc15 entry_proc15_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    ...
    .rows_read(entry_proc15_U0_rows_read),
    .rows_c_din(entry_proc15_U0_rows_c_din),
    .rows_c_num_data_valid(rows_c_num_data_valid),
    .rows_c_fifo_cap(rows_c_fifo_cap),
    .rows_c_full_n(rows_c_full_n),
    .rows_c_write(entry_proc15_U0_rows_c_write),
    .cols_dout(cols_dout),
    .cols_num_data_valid(2'd0),
    .cols_fifo_cap(2'd0),
    .cols_empty_n(cols_empty_n),
    .cols_read(entry_proc15_U0_cols_read),
    .cols_c_din(entry_proc15_U0_cols_c_din),
    .cols_c_num_data_valid(cols_c_num_data_valid),
    .cols_c_fifo_cap(cols_c_fifo_cap),
    .cols_c_full_n(cols_c_full_n),
    .cols_c_write(entry_proc15_U0_cols_c_write),
    .ap_ext_blocking_n(entry_proc15_U0_ap_ext_blocking_n),
    .ap_str_blocking_n(entry_proc15_U0_ap_str_blocking_n),
    .ap_int_blocking_n(entry_proc15_U0_ap_int_blocking_n)
);
...
canny_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    ...
    .in_mat_data1_din(AxiStream2MatStream_2_U0_in_mat_data1_din),
    .in_mat_data1_num_data_valid(2'd0),
    .in_mat_data1_fifo_cap(2'd0),
    .in_mat_data1_full_n(in_mat_data1_full_n),
    .in_mat_data1_write(AxiStream2MatStream_2_U0_in_mat_data1_write),
...
canny_accel_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc15_U0_rows_c_din),
    .if_full_n(rows_c_full_n),
    .if_write(entry_proc15_U0_rows_c_write),
    .if_dout(rows_c_dout),
...
canny_accel_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc15_U0_cols_c_din),
    .if_full_n(cols_c_full_n),
    .if_write(entry_proc15_U0_cols_c_write),
    .if_dout(cols_c_dout),
...
canny_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_ext_blocking_sub_n = (last_blk_pxl_width_1_U0_ap_ext_blocking_n & entry_proc15_U0_ap_ext_blocking_n & AxiStream2MatStream_2_U0_ap_ext_blocking_n);

assign ap_idle = (last_blk_pxl_width_1_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc15_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (last_blk_pxl_width_1_U0_ap_int_blocking_n & entry_proc15_U0_ap_int_blocking_n & AxiStream2MatStream_2_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (last_blk_pxl_width_1_U0_ap_str_blocking_n & entry_proc15_U0_ap_str_blocking_n & AxiStream2MatStream_2_U0_ap_str_blocking_n);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_1_U0_ap_ready & ap_sync_entry_proc15_U0_ap_ready);

assign cols_read = entry_proc15_U0_cols_read;
...
assign in_mat_data1_din = AxiStream2MatStream_2_U0_in_mat_data1_din;

assign in_mat_data1_write = AxiStream2MatStream_2_U0_in_mat_data1_write;
...
assign rows_read = entry_proc15_U0_rows_read;
