...
module canny_accel_xFSobel3x3_Pipeline_VITIS_LOOP_468_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [12:0] col_V_6_reg_180;
wire   [63:0] zext_ln541_fu_163_p1;
reg   [12:0] col_V_fu_58;
wire   [12:0] col_V_7_fu_152_p2;
wire    ap_loop_init;
reg   [12:0] ap_sig_allocacmp_col_V_6;
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_col_V_6 = 13'd0;
    end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((gaussian_mat_data1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((gaussian_mat_data1_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (gaussian_mat_data1_empty_n == 1'b0);
end
...
assign ap_int_blocking_cur_n = gaussian_mat_data1_blk_n;
...
assign buf_V_3_address1 = zext_ln541_fu_163_p1;

assign buf_V_3_d1 = gaussian_mat_data1_dout;

assign buf_V_4_address1 = zext_ln541_fu_163_p1;
...
assign col_V_7_fu_152_p2 = (ap_sig_allocacmp_col_V_6 + 13'd1);

assign icmp_ln1027_fu_146_p2 = ((zext_ln1027_fu_142_p1 < img_width) ? 1'b1 : 1'b0);

assign init_buf_cast_read_reg_176 = init_buf_cast;

assign zext_ln1027_fu_142_p1 = ap_sig_allocacmp_col_V_6;

assign zext_ln541_fu_163_p1 = col_V_6_reg_180;

endmodule //canny_accel_xFSobel3x3_Pipeline_VITIS_LOOP_468_2
