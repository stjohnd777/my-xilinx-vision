...
entity sobel_accel_control_s_axi is
generic (
...
end entity sobel_accel_control_s_axi;
...
-- 0x30 : reserved
-- 0x34 : Data signal of rows
--        bit 31~0 - rows[31:0] (Read/Write)
-- 0x38 : reserved
-- 0x3c : Data signal of cols
--        bit 31~0 - cols[31:0] (Read/Write)
-- 0x40 : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of sobel_accel_control_s_axi is
    ...
    constant ADDR_IMG_OUT1_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_IMG_OUT1_DATA_1 : INTEGER := 16#20#;
    constant ADDR_IMG_OUT1_CTRL   : INTEGER := 16#24#;
    constant ADDR_IMG_OUT2_DATA_0 : INTEGER := 16#28#;
    constant ADDR_IMG_OUT2_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_IMG_OUT2_CTRL   : INTEGER := 16#30#;
    constant ADDR_ROWS_DATA_0     : INTEGER := 16#34#;
    constant ADDR_ROWS_CTRL       : INTEGER := 16#38#;
    constant ADDR_COLS_DATA_0     : INTEGER := 16#3c#;
    constant ADDR_COLS_CTRL       : INTEGER := 16#40#;
    ...
    signal int_img_out1        : UNSIGNED(63 downto 0) := (others => '0');
    signal int_img_out2        : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_IMG_OUT1_DATA_0 =>
                        rdata_data <= RESIZE(int_img_out1(31 downto 0), 32);
                    when ADDR_IMG_OUT1_DATA_1 =>
                        rdata_data <= RESIZE(int_img_out1(63 downto 32), 32);
                    when ADDR_IMG_OUT2_DATA_0 =>
                        rdata_data <= RESIZE(int_img_out2(31 downto 0), 32);
                    when ADDR_IMG_OUT2_DATA_1 =>
                        rdata_data <= RESIZE(int_img_out2(63 downto 32), 32);
...
-- ----------------------- Register logic ----------------
    ...
    img_out1             <= STD_LOGIC_VECTOR(int_img_out1);
    img_out2             <= STD_LOGIC_VECTOR(int_img_out2);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_OUT1_DATA_0) then
                    int_img_out1(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_img_out1(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_OUT1_DATA_1) then
                    int_img_out1(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_img_out1(63 downto 32));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_OUT2_DATA_0) then
                    int_img_out2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_img_out2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_IMG_OUT2_DATA_1) then
                    int_img_out2(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_img_out2(63 downto 32));
                end if;
            end if;
        end if;
    end process;
