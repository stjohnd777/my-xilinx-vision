...
architecture behav of fast_accel_Mat2Axi is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc8_U0_dout_c_din : STD_LOGIC_VECTOR (63 downto 0);
    signal entry_proc8_U0_dout_c_write : STD_LOGIC;
    ...
    signal addrbound_U0_p_channel : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal Mat2Axi_Block_entry24_proc_U0_ap_return : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal Mat2AxiStream_U0_imgOutput_data2_read : STD_LOGIC;
    ...
    signal AxiStream2Axi_U0_m_axi_gmem1_AWVALID : STD_LOGIC;
    signal AxiStream2Axi_U0_m_axi_gmem1_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_WVALID : STD_LOGIC;
    signal AxiStream2Axi_U0_m_axi_gmem1_WDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_WSTRB : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_WLAST : STD_LOGIC;
    signal AxiStream2Axi_U0_m_axi_gmem1_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARVALID : STD_LOGIC;
    signal AxiStream2Axi_U0_m_axi_gmem1_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal AxiStream2Axi_U0_m_axi_gmem1_RREADY : STD_LOGIC;
    signal AxiStream2Axi_U0_m_axi_gmem1_BREADY : STD_LOGIC;
    ...
    signal p_channel_dout : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal axibound_V_dout : STD_LOGIC_VECTOR (23 downto 0);
    ...
    component fast_accel_entry_proc8 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fast_accel_addrbound IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        p_channel : OUT STD_LOGIC_VECTOR (23 downto 0);
        rows : IN STD_LOGIC_VECTOR (15 downto 0);
    ...
    component fast_accel_Mat2Axi_Block_entry24_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        axibound_V_1 : IN STD_LOGIC_VECTOR (23 downto 0);
    ...
    component fast_accel_Mat2AxiStream IS
    port (
        imgOutput_data2_dout : IN STD_LOGIC_VECTOR (7 downto 0);
        imgOutput_data2_empty_n : IN STD_LOGIC;
        imgOutput_data2_read : OUT STD_LOGIC;
    ...
    component fast_accel_AxiStream2Axi IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component fast_accel_fifo_w64_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component fast_accel_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component fast_accel_fifo_w8_d2_S_x0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc8_U0 : component fast_accel_entry_proc8
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    addrbound_U0 : component fast_accel_addrbound
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2Axi_Block_entry24_proc_U0 : component fast_accel_Mat2Axi_Block_entry24_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Mat2AxiStream_U0 : component fast_accel_Mat2AxiStream
    port map (
    ...
    AxiStream2Axi_U0 : component fast_accel_AxiStream2Axi
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dout_c_U : component fast_accel_fifo_w64_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    p_channel_U : component fast_accel_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    axibound_V_U : component fast_accel_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ldata_U : component fast_accel_fifo_w8_d2_S_x0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_ext_blocking_sub_n <= (entry_proc8_U0_ap_ext_blocking_n and addrbound_U0_ap_ext_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_ext_blocking_n and Mat2AxiStream_U0_ap_ext_blocking_n and AxiStream2Axi_U0_ap_ext_blocking_n);
    ap_idle <= ((axibound_V_empty_n xor ap_const_logic_1) and (p_channel_empty_n xor ap_const_logic_1) and entry_proc8_U0_ap_idle and addrbound_U0_ap_idle and Mat2Axi_Block_entry24_proc_U0_ap_idle and Mat2AxiStream_U0_ap_idle and AxiStream2Axi_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (entry_proc8_U0_ap_int_blocking_n and addrbound_U0_ap_int_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_int_blocking_n and Mat2AxiStream_U0_ap_int_blocking_n and AxiStream2Axi_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (entry_proc8_U0_ap_str_blocking_n and addrbound_U0_ap_str_blocking_n and Mat2Axi_Block_entry24_proc_U0_ap_str_blocking_n and Mat2AxiStream_U0_ap_str_blocking_n and AxiStream2Axi_U0_ap_str_blocking_n);
    ...
    ap_sync_ready <= (ap_sync_entry_proc8_U0_ap_ready and ap_sync_addrbound_U0_ap_ready and ap_sync_Mat2AxiStream_U0_ap_ready);
