...
entity threshold_accel_Mat2AxiStream is
port (
...
architecture behav of threshold_accel_Mat2AxiStream is 
...
attribute shreg_extract : string;
    ...
    signal MatStream2AxiStream_1_U0_ap_start : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_done : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_continue : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_idle : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_ready : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_out_mat_data2_read : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ldata1_din : STD_LOGIC_VECTOR (255 downto 0);
    signal MatStream2AxiStream_1_U0_ldata1_write : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_rows_read : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_cols_bound_per_npc_read : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_ext_blocking_n : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_str_blocking_n : STD_LOGIC;
    signal MatStream2AxiStream_1_U0_ap_int_blocking_n : STD_LOGIC;
    ...
    component threshold_accel_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_last_blk_pxl_width_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_MatStream2AxiStream_1_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component threshold_accel_fifo_w16_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component threshold_accel_fifo_w32_d3_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component threshold_accel_fifo_w4_d2_S_x IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component threshold_accel_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    last_blk_pxl_width_1_U0 : component threshold_accel_last_blk_pxl_width_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MatStream2AxiStream_1_U0 : component threshold_accel_MatStream2AxiStream_1_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => MatStream2AxiStream_1_U0_ap_start,
        ap_done => MatStream2AxiStream_1_U0_ap_done,
        ap_continue => MatStream2AxiStream_1_U0_ap_continue,
        ap_idle => MatStream2AxiStream_1_U0_ap_idle,
        ap_ready => MatStream2AxiStream_1_U0_ap_ready,
        ...
        out_mat_data2_read => MatStream2AxiStream_1_U0_out_mat_data2_read,
        ldata1_din => MatStream2AxiStream_1_U0_ldata1_din,
        ldata1_num_data_valid => ap_const_lv2_0,
        ldata1_fifo_cap => ap_const_lv2_0,
        ldata1_full_n => ldata1_full_n,
        ldata1_write => MatStream2AxiStream_1_U0_ldata1_write,
        rows_dout => rows_c_dout,
        rows_num_data_valid => rows_c_num_data_valid,
        rows_fifo_cap => rows_c_fifo_cap,
        rows_empty_n => rows_c_empty_n,
        rows_read => MatStream2AxiStream_1_U0_rows_read,
        ...
        cols_bound_per_npc_read => MatStream2AxiStream_1_U0_cols_bound_per_npc_read,
        last_blk_width => last_blk_width_channel_dout,
        ap_ext_blocking_n => MatStream2AxiStream_1_U0_ap_ext_blocking_n,
        ap_str_blocking_n => MatStream2AxiStream_1_U0_ap_str_blocking_n,
        ap_int_blocking_n => MatStream2AxiStream_1_U0_ap_int_blocking_n);

    rows_c_U : component threshold_accel_fifo_w16_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        ...
        if_read => MatStream2AxiStream_1_U0_rows_read);

    cols_c_U : component threshold_accel_fifo_w32_d3_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => MatStream2AxiStream_1_U0_cols_bound_per_npc_read);

    last_blk_width_channel_U : component threshold_accel_fifo_w4_d2_S_x
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        ...
        if_read => MatStream2AxiStream_1_U0_ap_ready);
    ...
    MatStream2AxiStream_1_U0_ap_continue <= ap_continue;
    MatStream2AxiStream_1_U0_ap_start <= last_blk_width_channel_empty_n;
    ap_done <= MatStream2AxiStream_1_U0_ap_done;
    ap_ext_blocking_cur_n <= ap_const_logic_1;
    ap_ext_blocking_n <= (ap_ext_blocking_sub_n and ap_ext_blocking_cur_n);
    ap_ext_blocking_sub_n <= (last_blk_pxl_width_1_U0_ap_ext_blocking_n and entry_proc_U0_ap_ext_blocking_n and MatStream2AxiStream_1_U0_ap_ext_blocking_n);
    ap_idle <= (last_blk_pxl_width_1_U0_ap_idle and (last_blk_width_channel_empty_n xor ap_const_logic_1) and entry_proc_U0_ap_idle and MatStream2AxiStream_1_U0_ap_idle);
    ap_int_blocking_cur_n <= ap_const_logic_1;
    ap_int_blocking_n <= (ap_int_blocking_sub_n and ap_int_blocking_cur_n);
    ap_int_blocking_sub_n <= (last_blk_pxl_width_1_U0_ap_int_blocking_n and entry_proc_U0_ap_int_blocking_n and MatStream2AxiStream_1_U0_ap_int_blocking_n);
    ap_ready <= ap_sync_ready;
    ap_str_blocking_cur_n <= ap_const_logic_1;
    ap_str_blocking_n <= (ap_str_blocking_sub_n and ap_str_blocking_cur_n);
    ap_str_blocking_sub_n <= (last_blk_pxl_width_1_U0_ap_str_blocking_n and entry_proc_U0_ap_str_blocking_n and MatStream2AxiStream_1_U0_ap_str_blocking_n);
