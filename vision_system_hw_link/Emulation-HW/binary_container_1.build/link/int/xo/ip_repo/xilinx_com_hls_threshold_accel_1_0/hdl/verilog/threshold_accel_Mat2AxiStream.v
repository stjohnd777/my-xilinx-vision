...
wire    last_blk_pxl_width_1_U0_ap_ext_blocking_n;
wire    last_blk_pxl_width_1_U0_ap_str_blocking_n;
wire    last_blk_pxl_width_1_U0_ap_int_blocking_n;
wire    last_blk_width_channel_full_n;
wire    MatStream2AxiStream_1_U0_ap_start;
wire    MatStream2AxiStream_1_U0_ap_done;
wire    MatStream2AxiStream_1_U0_ap_continue;
wire    MatStream2AxiStream_1_U0_ap_idle;
wire    MatStream2AxiStream_1_U0_ap_ready;
wire    MatStream2AxiStream_1_U0_out_mat_data2_read;
wire   [255:0] MatStream2AxiStream_1_U0_ldata1_din;
wire    MatStream2AxiStream_1_U0_ldata1_write;
wire    MatStream2AxiStream_1_U0_rows_read;
wire    MatStream2AxiStream_1_U0_cols_bound_per_npc_read;
wire    MatStream2AxiStream_1_U0_ap_ext_blocking_n;
wire    MatStream2AxiStream_1_U0_ap_str_blocking_n;
wire    MatStream2AxiStream_1_U0_ap_int_blocking_n;
wire    rows_c_full_n;
...
threshold_accel_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_last_blk_pxl_width_1 last_blk_pxl_width_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_MatStream2AxiStream_1_s MatStream2AxiStream_1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
threshold_accel_fifo_w16_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w32_d3_S_x cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
threshold_accel_fifo_w4_d2_S_x last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign MatStream2AxiStream_1_U0_ap_continue = ap_continue;

assign MatStream2AxiStream_1_U0_ap_start = last_blk_width_channel_empty_n;

assign ap_done = MatStream2AxiStream_1_U0_ap_done;

assign ap_ext_blocking_cur_n = 1'b1;

assign ap_ext_blocking_n = (ap_ext_blocking_sub_n & ap_ext_blocking_cur_n);

assign ap_ext_blocking_sub_n = (last_blk_pxl_width_1_U0_ap_ext_blocking_n & entry_proc_U0_ap_ext_blocking_n & MatStream2AxiStream_1_U0_ap_ext_blocking_n);

assign ap_idle = (last_blk_pxl_width_1_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc_U0_ap_idle & MatStream2AxiStream_1_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (last_blk_pxl_width_1_U0_ap_int_blocking_n & entry_proc_U0_ap_int_blocking_n & MatStream2AxiStream_1_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (last_blk_pxl_width_1_U0_ap_str_blocking_n & entry_proc_U0_ap_str_blocking_n & MatStream2AxiStream_1_U0_ap_str_blocking_n);
...
assign ldata1_din = MatStream2AxiStream_1_U0_ldata1_din;

assign ldata1_write = MatStream2AxiStream_1_U0_ldata1_write;

assign out_mat_data2_read = MatStream2AxiStream_1_U0_out_mat_data2_read;
