...
module fast_accel_AxiStream2Mat (
        ldata1_dout,
        ldata1_empty_n,
        ldata1_read,
        imgInput_data1_din,
...
wire    entry_proc7_U0_rows_read;
wire   [31:0] entry_proc7_U0_rows_c_din;
wire    entry_proc7_U0_rows_c_write;
wire    entry_proc7_U0_cols_read;
wire   [31:0] entry_proc7_U0_cols_c_din;
wire    entry_proc7_U0_cols_c_write;
...
fast_accel_entry_proc7 entry_proc7_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fast_accel_last_blk_pxl_width last_blk_pxl_width_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fast_accel_AxiStream2MatStream_2_s AxiStream2MatStream_2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
fast_accel_fifo_w32_d3_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc7_U0_rows_c_din),
    .if_full_n(rows_c_full_n),
    .if_write(entry_proc7_U0_rows_c_write),
    .if_dout(rows_c_dout),
...
fast_accel_fifo_w32_d3_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(entry_proc7_U0_cols_c_din),
    .if_full_n(cols_c_full_n),
    .if_write(entry_proc7_U0_cols_c_write),
    .if_dout(cols_c_dout),
...
fast_accel_fifo_w4_d2_S last_blk_width_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_ext_blocking_sub_n = (last_blk_pxl_width_U0_ap_ext_blocking_n & entry_proc7_U0_ap_ext_blocking_n & AxiStream2MatStream_2_U0_ap_ext_blocking_n);

assign ap_idle = (last_blk_pxl_width_U0_ap_idle & (last_blk_width_channel_empty_n ^ 1'b1) & entry_proc7_U0_ap_idle & AxiStream2MatStream_2_U0_ap_idle);

assign ap_int_blocking_cur_n = 1'b1;

assign ap_int_blocking_n = (ap_int_blocking_sub_n & ap_int_blocking_cur_n);

assign ap_int_blocking_sub_n = (last_blk_pxl_width_U0_ap_int_blocking_n & entry_proc7_U0_ap_int_blocking_n & AxiStream2MatStream_2_U0_ap_int_blocking_n);
...
assign ap_str_blocking_sub_n = (last_blk_pxl_width_U0_ap_str_blocking_n & entry_proc7_U0_ap_str_blocking_n & AxiStream2MatStream_2_U0_ap_str_blocking_n);
...
assign ap_sync_ready = (ap_sync_last_blk_pxl_width_U0_ap_ready & ap_sync_entry_proc7_U0_ap_ready);

assign cols_read = entry_proc7_U0_cols_read;
...
assign rows_read = entry_proc7_U0_rows_read;

endmodule //fast_accel_AxiStream2Mat
