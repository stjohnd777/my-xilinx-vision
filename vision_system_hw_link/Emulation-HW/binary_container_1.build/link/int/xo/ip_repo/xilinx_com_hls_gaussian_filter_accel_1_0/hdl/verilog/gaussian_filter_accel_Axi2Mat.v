...
module gaussian_filter_accel_Axi2Mat (
        m_axi_gmem1_AWVALID,
        m_axi_gmem1_AWREADY,
        m_axi_gmem1_AWADDR,
        m_axi_gmem1_AWID,
...
wire   [255:0] Axi2AxiStream_U0_m_axi_gmem1_WDATA;
wire   [31:0] Axi2AxiStream_U0_m_axi_gmem1_WSTRB;
...
wire   [255:0] Axi2AxiStream_U0_ldata_din;
...
gaussian_filter_accel_Axi2AxiStream Axi2AxiStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
gaussian_filter_accel_AxiStream2Mat AxiStream2Mat_U0(
...
gaussian_filter_accel_fifo_w256_d2_S ldata_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
gaussian_filter_accel_fifo_w32_d2_S rows_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
gaussian_filter_accel_fifo_w32_d2_S cols_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
gaussian_filter_accel_start_for_AxiStream2Mat_U0 start_for_AxiStream2Mat_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //gaussian_filter_accel_Axi2Mat
