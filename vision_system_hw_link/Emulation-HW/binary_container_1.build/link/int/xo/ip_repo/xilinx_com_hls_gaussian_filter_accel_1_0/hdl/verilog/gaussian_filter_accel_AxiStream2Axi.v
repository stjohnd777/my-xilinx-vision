...
module gaussian_filter_accel_AxiStream2Axi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [255:0] grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_m_axi_gmem2_WDATA;
wire   [31:0] grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_m_axi_gmem2_WSTRB;
...
wire    grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_ap_ext_blocking_n;
wire    grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_ap_str_blocking_n;
wire    grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_ap_int_blocking_n;
...
gaussian_filter_accel_AxiStream2Axi_Pipeline_MMIterOutLoop2 grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        trunc_ln_reg_113 <= {{dout_dout[63:5]}};
    end
end
...
always @ (*) begin
    if ((grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_ap_ext_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_ap_int_blocking_n == 1'b0)) begin
...
always @ (*) begin
    if ((grp_AxiStream2Axi_Pipeline_MMIterOutLoop2_fu_73_ap_str_blocking_n == 1'b0)) begin
...
assign ap_ext_blocking_cur_n = (gmem2_blk_n_B & gmem2_blk_n_AW);
...
endmodule //gaussian_filter_accel_AxiStream2Axi
